...
public class ServiceLocator extends org.apache.axis.client.Service implements ar.com.comit.wsfex.Service {
 ...
 */
    ...
    public ar.com.comit.wsfex.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public ar.com.comit.wsfex.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ar.com.comit.wsfex.ServiceSoapStub _stub = new ar.com.comit.wsfex.ServiceSoapStub(portAddress, this);
    ...
    public ar.com.comit.wsfex.ServiceSoap getServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public ar.com.comit.wsfex.ServiceSoap getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ar.com.comit.wsfex.ServiceSoap12Stub _stub = new ar.com.comit.wsfex.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ar.com.comit.wsfex.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                ar.com.comit.wsfex.ServiceSoapStub _stub = new ar.com.comit.wsfex.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (ar.com.comit.wsfex.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                ar.com.comit.wsfex.ServiceSoap12Stub _stub = new ar.com.comit.wsfex.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
