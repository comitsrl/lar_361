...
// N
	...
	/** Set docsubtypecae.
		@param docsubtypecae docsubtypecae	  */
	public void setdocsubtypecae (String docsubtypecae)
	{

		set_Value (COLUMNNAME_docsubtypecae, docsubtypecae);
	}
	...
	/** Set docsubtypeinv.
		@param docsubtypeinv docsubtypeinv	  */
	...
	public void setfiscaldocument (String fiscaldocument)
	{
		...
		set_Value (COLUMNNAME_fiscaldocument, fiscaldocument);
	}
	...
	/** GenerateWithholding AD_Reference_ID=1000004 */
	public static final int GENERATEWITHHOLDING_AD_Reference_ID=1000004;
	/** Yes = Y */
	...
	/** Set isfiscaldocument.
		@param isfiscaldocument isfiscaldocument	  */
	public void setisfiscaldocument (boolean isfiscaldocument)
	{
		set_Value (COLUMNNAME_isfiscaldocument, Boolean.valueOf(isfiscaldocument));
	}
	...
	public void setLAR_Fiscal_Printer_ID (int LAR_Fiscal_Printer_ID)
	{
		if (LAR_Fiscal_Printer_ID < 1) 
			set_Value (COLUMNNAME_LAR_Fiscal_Printer_ID, null);
		else 
			set_Value (COLUMNNAME_LAR_Fiscal_Printer_ID, Integer.valueOf(LAR_Fiscal_Printer_ID));
	}
