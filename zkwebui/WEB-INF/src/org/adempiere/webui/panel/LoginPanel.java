    ...
    **/
    public void validateLogin()
    {
        ...
        else
        {
            ...
            Clients.response("zkLocaleJavaScript", new AuScript(null, outLocaleJavaScript()));
	...
	/***********************************************************************
	 * @fchiappano Codigo extraido de la clase DspFns versión 3.5.2,
	 * del jar zk.jar de Zkoss, para compatibilizar con login actual de AD.
	 ***********************************************************************/
