...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3000496,'notacredito_id','LAR','notacredito_id','notacredito_id',0,TO_DATE('2017-11-06 17:52:05','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2017-11-06 17:52:05','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- BUG #402: Utilizar Nota de Credito como forma de pago, en el POS.
UPDATE AD_Element SET ColumnName='NotaCredito_ID', Name='Nota de Crédito', PrintName='Nota de Crédito',Updated=TO_DATE('2017-11-06 17:54:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000496
;
...
-- 06/11/2017 17:54:26 ART
-- BUG #402: Utilizar Nota de Credito como forma de pago, en el POS.
UPDATE AD_PrintFormatItem pi SET PrintName='Nota de Crédito', Name='Nota de Crédito' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3000496)
;

-- 06/11/2017 17:54:34 ART
-- BUG #402: Utilizar Nota de Credito como forma de pago, en el POS.
UPDATE AD_Element_Trl SET Name='Nota de Crédito',PrintName='Nota de Crédito',Updated=TO_DATE('2017-11-06 17:54:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000496 AND AD_Language='es_AR'
;

-- 09/11/2017 17:07:47 ART
-- BUG #402: Utilizar Nota de Credito como forma de pago, en el POS.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3002197,390,'LAR',0,'N','N','N','N',10,'N',19,'N',3000496,'N','Y','N','Nota de Crédito','NotaCredito_ID',100,TO_DATE('2017-11-09 17:07:46','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2017-11-09 17:07:46','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- BUG #402: Utilizar Nota de Credito como forma de pago, en el POS.
UPDATE AD_Field SET IsSameLine='Y', IsReadOnly='Y',Updated=TO_DATE('2017-11-09 17:15:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3003721
;

-- 09/11/2017 17:17:22 ART
-- BUG #402: Utilizar Nota de Credito como forma de pago, en el POS.
UPDATE AD_Column SET AD_Reference_Value_ID=336, AD_Reference_ID=18,Updated=TO_DATE('2017-11-09 17:17:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002197
;
