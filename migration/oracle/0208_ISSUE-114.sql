...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001239,'porcdiferenciaacordado','LAR','porcdiferenciaacordado','porcdiferenciaacordado',0,TO_DATE('2022-03-20 10:03:10','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2022-03-20 10:03:10','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- ISSUE #114: Facturación Moneda Extrangera
UPDATE AD_Element SET ColumnName='PorcDiferenciaAcordado', Name='PorcDiferenciaAcordado', PrintName='PorcDiferenciaAcordado',Updated=TO_DATE('2022-03-20 10:07:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001239
;
...
-- 20/03/2022 10:07:15 ART
-- ISSUE #114: Facturación Moneda Extrangera
UPDATE AD_PrintFormatItem pi SET PrintName='PorcDiferenciaAcordado', Name='PorcDiferenciaAcordado' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001239)
;

-- 20/03/2022 10:07:38 ART
-- ISSUE #114: Facturación Moneda Extrangera
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Porc. Diferencia Acordado',PrintName='Porc. Diferencia Acordado',Updated=TO_DATE('2022-03-20 10:07:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001239 AND AD_Language='es_AR'
;

-- 20/03/2022 10:07:47 ART
-- ISSUE #114: Facturación Moneda Extrangera
UPDATE AD_Column SET FieldLength=22, Name='PorcDiferenciaAcordado', ColumnName='PorcDiferenciaAcordado',Updated=TO_DATE('2022-03-20 10:07:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004437
;

-- 20/03/2022 10:12:29 ART
-- ISSUE #114: Facturación Moneda Extrangera
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3007757,22,'Y','N','N',3004437,'N','Y',223,'N','LAR','PorcDiferenciaAcordado',100,0,TO_DATE('2022-03-20 10:12:29','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_DATE('2022-03-20 10:12:29','YYYY-MM-DD HH24:MI:SS'))
;
...
SELECT register_migration_script_lar('0208_ISSUE-114.sql', 'LAR', '') FROM dual
;
