...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001393,'aplicaensaldo','LAR','aplicaensaldo','aplicaensaldo',0,TO_DATE('2023-04-24 00:38:34','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2023-04-24 00:38:34','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ADP #3: Aplica descuento en Saldo
UPDATE AD_Element SET ColumnName='AplicaEnSaldo', Name='Aplica en Saldo', PrintName='Aplica en Saldo',Updated=TO_DATE('2023-04-24 00:41:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001393
;
...
-- 24/04/2023 0:41:21 ART
-- ADP #3: Aplica descuento en Saldo
UPDATE AD_PrintFormatItem pi SET PrintName='Aplica en Saldo', Name='Aplica en Saldo' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001393)
;

-- 24/04/2023 0:41:25 ART
-- ADP #3: Aplica descuento en Saldo
UPDATE AD_Element_Trl SET Name='Aplica en Saldo',PrintName='Aplica en Saldo',Updated=TO_DATE('2023-04-24 00:41:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001393 AND AD_Language='es_AR'
;

-- 24/04/2023 0:41:34 ART
-- ADP #3: Aplica descuento en Saldo
UPDATE AD_Column_Trl SET Name='Aplica en Saldo',Updated=TO_DATE('2023-04-24 00:41:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005573 AND AD_Language='es_AR'
;

-- 24/04/2023 0:42:24 ART
-- ADP #3: Aplica descuento en Saldo
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3008389,1,'Y','N','N',3005573,'N','Y',3000057,'N','LAR','Aplica en Saldo',100,0,'Y',TO_DATE('2023-04-24 00:42:24','YYYY-MM-DD HH24:MI:SS'),0,TO_DATE('2023-04-24 00:42:24','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ADP #3: Aplica descuento en Saldo
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2023-04-24 00:42:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001894
;
