...
-- ISSUE #126: Funcionalidad de Reparto/Entrega Diferida.
INSERT INTO AD_Val_Rule (Code,Type,AD_Val_Rule_ID,EntityType,Name,CreatedBy,UpdatedBy,Updated,AD_Client_ID,IsActive,AD_Org_ID,Created) VALUES ('(M_Warehouse.AD_Org_ID IN (SELECT AD_Org_ID FROM AD_OrgInfo WHERE IsMiles=''N'')','S',3000148,'LAR','M_Warehouse - No Miles',100,100,TO_DATE('2024-08-14 10:13:16','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,TO_DATE('2024-08-14 10:13:16','YYYY-MM-DD HH24:MI:SS'))
;

-- 14/08/2024 10:13:38 ART
-- ISSUE #126: Funcionalidad de Reparto/Entrega Diferida.
UPDATE AD_Column SET AD_Val_Rule_ID=3000148,Updated=TO_DATE('2024-08-14 10:13:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=2223
;

-- 14/08/2024 10:17:04 ART
-- ISSUE #126: Funcionalidad de Reparto/Entrega Diferida.
UPDATE AD_Column SET AD_Val_Rule_ID=NULL,Updated=TO_DATE('2024-08-14 10:17:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=2223
;

-- 14/08/2024 10:18:00 ART
-- ISSUE #126: Funcionalidad de Reparto/Entrega Diferida.
UPDATE AD_Val_Rule SET Code='(M_Warehouse.AD_Org_ID IN (SELECT AD_Org_ID FROM AD_OrgInfo WHERE IsMiles=''N''))',Updated=TO_DATE('2024-08-14 10:18:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=3000148
;

-- 14/08/2024 10:18:06 ART
-- ISSUE #126: Funcionalidad de Reparto/Entrega Diferida.
UPDATE AD_Column SET AD_Val_Rule_ID=3000148,Updated=TO_DATE('2024-08-14 10:18:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=2223
;

-- Registración de script
SELECT register_migration_script_lar('0227_ISSUE-167.sql', 'LAR', '') FROM dual
;
