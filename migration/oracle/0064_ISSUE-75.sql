...
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3001210,259,'LAR',0,'N','N','N','N',10,'N',19,'N',3000079,'N','Y','N','Source_Invoice_ID','Source_Invoice_ID',100,TO_DATE('2015-12-22 08:53:59','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2015-12-22 08:53:59','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #75: Orden de Nota de Crédito
UPDATE AD_Column SET AD_Reference_Value_ID=3000012, AD_Reference_ID=30,Updated=TO_DATE('2015-12-22 09:01:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001210
;

-- 22/12/2015 9:01:42 ART
-- ISSUE #75: Orden de Nota de Crédito
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_DATE('2015-12-22 09:01:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001210
;

-- 22/12/2015 9:01:53 ART
-- ISSUE #75: Orden de Nota de Crédito
UPDATE AD_Field SET Name='Source_Invoice_ID',Updated=TO_DATE('2015-12-22 09:01:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3002015
;
...
-- ISSUE #75: Orden de Nota de Crédito
UPDATE AD_Field_Trl SET IsTranslated='Y',Description='Factura Origen',Updated=TO_DATE('2015-12-22 09:03:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3002015 AND AD_Language='es_AR'
;

-- 22/12/2015 9:03:56 ART
-- ISSUE #75: Orden de Nota de Crédito
UPDATE AD_Field_Trl SET Name='Factura Origen',Description='Factura a partir de la cual se generará la Nota de Crédito',Updated=TO_DATE('2015-12-22 09:03:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3002015 AND AD_Language='es_AR'
;
...
-- ISSUE #75: Orden de Nota de Crédito
UPDATE AD_Field SET DisplayLogic='@C_DocTypeTarget_ID@=1000130 | @C_DocTypeTarget_ID@=1000131 | @C_DocTypeTarget_ID@=1000133 | @C_DocTypeTarget_ID@=1000134',Updated=TO_DATE('2015-12-22 09:26:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3002015
;

-- 22/12/2015 9:31:58 ART
-- ISSUE #75: Orden de Nota de Crédito
UPDATE AD_Column SET MandatoryLogic='@C_DocTypeTarget_ID@=1000130 | @C_DocTypeTarget_ID@=1000131 | @C_DocTypeTarget_ID@=1000133 | @C_DocTypeTarget_ID@=1000134',Updated=TO_DATE('2015-12-22 09:31:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001210
;
...
-- BUG #291: Orden de Nota de Crédito
UPDATE AD_Column SET Callout='ar.com.ergio.model.LAR_Callouts.copiaLineasDesdeFacturaOrigen',Updated=TO_DATE('2015-12-28 20:09:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001210
;

-- Registración de script
SELECT register_migration_script_lar('0064_ISSUE-75.sql', 'LAR', '') FROM dual
;
