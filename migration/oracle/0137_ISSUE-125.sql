...
-- ISSUE #125: Eximir de IVA a Consumidores Finales sobre ciertos productos.
UPDATE AD_Column SET Name='Exento de IVA Venta', ColumnName='ExentoIVAVenta',Updated=TO_DATE('2019-08-16 17:08:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003525
;
...
-- ISSUE #125: Eximir de IVA a Consumidores Finales sobre ciertos productos.
UPDATE AD_Column_Trl SET Name='Exento de IVA Venta',Updated=TO_DATE('2019-08-16 17:08:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003525 AND AD_Language='es_AR'
;

-- 16/08/2019 17:08:56 ART
-- ISSUE #125: Eximir de IVA a Consumidores Finales sobre ciertos productos.
UPDATE AD_Element SET ColumnName='ExentoIVAVenta', Name='Exento de IVA Venta', PrintName='Exento de IVA Venta',Updated=TO_DATE('2019-08-16 17:08:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001042
;
...
-- 16/08/2019 17:08:56 ART
-- ISSUE #125: Eximir de IVA a Consumidores Finales sobre ciertos productos.
UPDATE AD_PrintFormatItem pi SET PrintName='Exento de IVA Venta', Name='Exento de IVA Venta' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001042)
;

-- 16/08/2019 17:09:05 ART
-- ISSUE #125: Eximir de IVA a Consumidores Finales sobre ciertos productos.
UPDATE AD_Element_Trl SET Name='Exento de IVA Venta',PrintName='Exento de IVA Venta',Updated=TO_DATE('2019-08-16 17:09:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001042 AND AD_Language='es_AR'
;

-- 16/08/2019 17:10:58 ART
-- ISSUE #125: Eximir de IVA a Consumidores Finales sobre ciertos productos.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3006606,1,'Y','N','N',3003525,'N','Y',180,'N','LAR','Exento de IVA Venta',100,0,'Y',TO_DATE('2019-08-16 17:10:57','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2019-08-16 17:10:57','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #125: Eximir de IVA a Consumidores Finales sobre ciertos productos.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2019-08-16 17:15:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006606
;
...
-- ISSUE #125: Eximir de IVA a Consumidores Finales sobre ciertos productos.
UPDATE AD_Field SET IsSameLine='Y', DisplayLogic='@IsCustomer@=''Y''',Updated=TO_DATE('2019-08-16 19:22:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=9657
;

-- Registración de script
SELECT register_migration_script_lar('0137_ISSUE-125.sql', 'LAR', '') FROM dual
;
