...
-- ISSUE #114: Tipo de Cambio en cabecera de Asignación.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,Help,EntityType,Description,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007369,10,'Y','N','N',3004178,'N','Y',661,'N','The Currency Conversion Rate Type lets you define different type of rates, e.g. Spot, Corporate and/or Sell/Buy rates.','LAR','Currency Conversion Rate Type','Currency Type',100,0,TO_DATE('2021-08-27 12:19:45','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2021-08-27 12:19:45','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Tipo de Cambio en cabecera de Asignación.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2021-08-27 12:22:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007369
;
...
-- ISSUE #114: Tipo de Cambio en cabecera de Asignación.
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_DATE('2021-08-27 13:24:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007369
;

-- Registración de script
SELECT register_migration_script_lar('0193_ISSUE-114.sql', 'LAR', '') FROM dual
;
