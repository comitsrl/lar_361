...
ALTER TABLE LAR_CardSettlement ADD COLUMN Fecha_Venc_Cheque timestamp without time zone
;
...
VALUES (3005988,3000284,'LAR',0,'N','N','N',29,'N','N',15,'N',3000419,'N','Y','N','Fecha de Venc. Cheque','Fecha_Venc_Cheque','Fecha de vencimiento del cheque',NULL,100,100,TO_DATE('2026-06-08 10:00:00','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2026-06-08 10:00:00','YYYY-MM-DD HH24:MI:SS'),0,0,'Y')
;
...
SET Name='Fecha de Venc. Cheque', IsTranslated='Y', Updated=TO_DATE('2026-06-08 10:00:00','YYYY-MM-DD HH24:MI:SS'), UpdatedBy=100
...
VALUES (3009509,3000319,3005988,29,'Y',145,'N','N','N','N','N','N','LAR','Fecha de Venc. Cheque','Fecha de vencimiento del cheque',NULL,0,0,100,100,TO_DATE('2026-06-08 10:00:00','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2026-06-08 10:00:00','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
UPDATE AD_Field_Trl
SET Name='Fecha de Venc. Cheque', Description='Fecha de vencimiento del cheque', IsTranslated='Y', Updated=TO_DATE('2026-06-08 10:00:00','YYYY-MM-DD HH24:MI:SS'), UpdatedBy=100
WHERE AD_Field_ID=3009509 AND AD_Language='es_AR'
;

UPDATE AD_Field
SET DisplayLogic='@OperationType@=''C''', IsReadOnly='N', Updated=TO_DATE('2026-06-08 10:00:00','YYYY-MM-DD HH24:MI:SS'), UpdatedBy=100
...
-- ISSUE#174: Liquidación Operativa Tarjetas
UPDATE AD_Column SET IsSelectionColumn='Y',Updated=TO_DATE('2026-06-08 09:28:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005974
;

-- 08/06/2026 9:28:48 ART
-- ISSUE#174: Liquidación Operativa Tarjetas
UPDATE AD_Column SET IsSelectionColumn='Y',Updated=TO_DATE('2026-06-08 09:28:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005972
;

-- 08/06/2026 9:28:53 ART
-- ISSUE#174: Liquidación Operativa Tarjetas
UPDATE AD_Column SET IsSelectionColumn='Y',Updated=TO_DATE('2026-06-08 09:28:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005981
;

-- 08/06/2026 9:29:01 ART
-- ISSUE#174: Liquidación Operativa Tarjetas
UPDATE AD_Column SET IsSelectionColumn='Y',Updated=TO_DATE('2026-06-08 09:29:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005966
;

-- 08/06/2026 9:29:09 ART
-- ISSUE#174: Liquidación Operativa Tarjetas
UPDATE AD_Column SET IsSelectionColumn='Y',Updated=TO_DATE('2026-06-08 09:29:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005970
;

-- 08/06/2026 9:29:22 ART
-- ISSUE#174: Liquidación Operativa Tarjetas
UPDATE AD_Column SET IsSelectionColumn='Y',Updated=TO_DATE('2026-06-08 09:29:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005988
;

-- 08/06/2026 9:29:35 ART
-- ISSUE#174: Liquidación Operativa Tarjetas
UPDATE AD_Column SET IsSelectionColumn='Y',Updated=TO_DATE('2026-06-08 09:29:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005973
;

SELECT register_migration_script_lar('0250_ISSUE-174.sql', 'LAR', '') FROM dual
;
