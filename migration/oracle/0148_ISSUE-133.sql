...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001057,'sincronizada','LAR','sincronizada','sincronizada',0,TO_DATE('2020-02-07 18:00:30','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2020-02-07 18:00:30','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- 07/02/2020 18:00:31 ART
-- ISSUE #133: Incorporar marcas sincronizadas en orden y factura.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003561,318,'LAR',0,'Y','N','N','N',1,'N',20,'N',3001057,'N','Y','N','sincronizada','sincronizada',100,TO_DATE('2020-02-07 18:00:30','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2020-02-07 18:00:30','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #133: Incorporar marcas sincronizadas en orden y factura.
UPDATE AD_Column SET Name='Sincronizada', ColumnName='Sincronizada',Updated=TO_DATE('2020-02-07 18:00:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003561
;
...
-- ISSUE #133: Incorporar marcas sincronizadas en orden y factura.
UPDATE AD_Column_Trl SET Name='Sincronizada',Updated=TO_DATE('2020-02-07 18:01:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003561 AND AD_Language='es_AR'
;

-- 07/02/2020 18:01:20 ART
-- ISSUE #133: Incorporar marcas sincronizadas en orden y factura.
UPDATE AD_Element SET ColumnName='Sincronizada', Name='Sincronizada', PrintName='Sincronizada',Updated=TO_DATE('2020-02-07 18:01:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001057
;
...
-- 07/02/2020 18:01:20 ART
-- ISSUE #133: Incorporar marcas sincronizadas en orden y factura.
UPDATE AD_PrintFormatItem pi SET PrintName='Sincronizada', Name='Sincronizada' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001057)
;

-- 07/02/2020 18:01:25 ART
-- ISSUE #133: Incorporar marcas sincronizadas en orden y factura.
UPDATE AD_Element_Trl SET Name='Sincronizada',PrintName='Sincronizada',Updated=TO_DATE('2020-02-07 18:01:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001057 AND AD_Language='es_AR'
;

-- 07/02/2020 18:01:58 ART
-- ISSUE #133: Incorporar marcas sincronizadas en orden y factura.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003562,259,'LAR',0,'Y','N','N','N',1,'N',20,'N',3001057,'N','Y','N','Sincronizada','Sincronizada',100,TO_DATE('2020-02-07 18:01:58','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2020-02-07 18:01:58','YYYY-MM-DD HH24:MI:SS'),100)
;
...
SELECT register_migration_script_lar('0148_ISSUE-133.sql', 'LAR', '') FROM dual
;
