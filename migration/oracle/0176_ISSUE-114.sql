...
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,Help,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Description,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003925,291,'LAR',0,'N','N','N','Indicates the Currency to be used when processing or reporting on this record','N',10,'N',19,'N',193,'N','Y','N','The Currency for this record','Currency','C_Currency_ID',100,TO_DATE('2021-06-02 21:36:38','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2021-06-02 21:36:38','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Configuración de Moneda en SdN.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,Help,EntityType,Description,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007053,10,'Y','N','N',3003925,'N','Y',223,'N','Indicates the Currency to be used when processing or reporting on this record','LAR','The Currency for this record','Currency',100,0,TO_DATE('2021-06-02 21:38:51','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2021-06-02 21:38:51','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Configuración de Moneda en SdN.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2021-06-02 21:39:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005535
;

-- Registración de script
SELECT register_migration_script_lar('0176_ISSUE-114.sql', 'LAR', '') FROM dual
;
