...
UPDATE AD_Column SET ColumnSQL='(CurrencyRate (100, 118, LAR_PaymentHeader.DateTrx, (SELECT bp.C_ConversionType_ID FROM C_BPartner bp WHERE bp.C_BPartner_ID = LAR_PaymentHeader.C_BPartner_ID), LAR_PaymentHeader.AD_Client_ID, LAR_PaymentHeader.AD_Org_ID))', IsMandatory='N', IsUpdateable='N', IsAllowCopy='N',Updated=TO_DATE('2018-11-28 15:51:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003028
;

-- 28/11/2018 16:08:06 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET Name='Diferencia de Valoración', ColumnName='DiferenciaValoracion',Updated=TO_DATE('2018-11-28 16:08:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003029
;
...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column_Trl SET Name='Diferencia de Valoración',Updated=TO_DATE('2018-11-28 16:08:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003029 AND AD_Language='es_AR'
;

-- 28/11/2018 16:09:03 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element SET ColumnName='DiferenciaValoracion', Name='Diferencia de Valoración', PrintName='Diferencia de Valoración',Updated=TO_DATE('2018-11-28 16:09:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000900
;
...
-- 28/11/2018 16:09:03 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_PrintFormatItem pi SET PrintName='Diferencia de Valoración', Name='Diferencia de Valoración' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3000900)
;

-- 28/11/2018 16:09:12 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element_Trl SET Name='Diferencia de Valoración',PrintName='Diferencia de Valoración',Updated=TO_DATE('2018-11-28 16:09:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000900 AND AD_Language='es_AR'
;

-- 28/11/2018 16:13:36 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='(CurrencyConvertRate ((SELECT COALESCE(Sum(Amount),0) FROM C_PaymentAllocate i WHERE  LAR_PaymentHeader.LAR_PaymentHeader_ID = i.LAR_PaymentHeader_ID), 100, 118, CurrencyRate (100, 118, LAR_PaymentHeader.DateTrx, (SELECT bp.C_ConversionType_ID FROM C_BPartner bp WHERE bp.C_BPartner_ID = LAR_PaymentHeader.C_BPartner_ID), LAR_PaymentHeader.AD_Client_ID, LAR_PaymentHeader.AD_Org_ID)) - CurrencyConvertRate ((SELECT COALESCE(Sum(Amount),0) FROM C_PaymentAllocate i WHERE  LAR_PaymentHeader.LAR_PaymentHeader_ID = i.LAR_PaymentHeader_ID), 100, 118, LAR_PaymentHeader.TasaCambio))',Updated=TO_DATE('2018-11-28 16:13:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003029
;

-- 28/11/2018 16:14:49 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='(CurrencyConvertRate ((SELECT COALESCE(Sum(Amount),0) FROM C_PaymentAllocate i WHERE  LAR_PaymentHeader.LAR_PaymentHeader_ID = i.LAR_PaymentHeader_ID), 100, 118, CurrencyRate (100, 118, LAR_PaymentHeader.DateTrx, (SELECT bp.C_ConversionType_ID FROM C_BPartner bp WHERE bp.C_BPartner_ID = LAR_PaymentHeader.C_BPartner_ID), LAR_PaymentHeader.AD_Client_ID, LAR_PaymentHeader.AD_Org_ID)) - CurrencyConvertRate ((SELECT COALESCE(Sum(Amount),0) FROM C_PaymentAllocate i WHERE  LAR_PaymentHeader.LAR_PaymentHeader_ID = i.LAR_PaymentHeader_ID), 100, 118, LAR_PaymentHeader.TasaDeCambio))',Updated=TO_DATE('2018-11-28 16:14:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003029
;

-- 28/11/2018 16:25:32 ART
-- ISSUE #80: Cierre de Cajas.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3000981,'%DiferenciaValoracion','LAR','% Dif. de Valoración','% Dif. de Valoración',0,TO_DATE('2018-11-28 16:25:31','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2018-11-28 16:25:31','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- ISSUE #80: Cierre de Cajas.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3006245,10,'Y','N','N',3003363,'N','Y',3000012,'N','LAR','% Dif. de Valoración',100,0,TO_DATE('2018-11-28 16:27:36','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2018-11-28 16:27:36','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2018-11-28 16:28:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006245
;

-- 28/11/2018 16:34:59 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element SET ColumnName='DiferenciaValoracion %', Name='Dif. de Valoración %', PrintName='Dif. de Valoración %',Updated=TO_DATE('2018-11-28 16:34:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000981
;
...
-- 28/11/2018 16:34:59 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_PrintFormatItem pi SET PrintName='Dif. de Valoración %', Name='Dif. de Valoración %' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3000981)
;

-- 28/11/2018 16:35:08 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element_Trl SET Name='Dif. de Valoración %',PrintName='Dif. de Valoración %',Updated=TO_DATE('2018-11-28 16:35:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000981 AND AD_Language='es_AR'
;

-- 28/11/2018 16:51:02 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column_Trl SET Name='Dif. de Valoración %',Updated=TO_DATE('2018-11-28 16:51:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003363 AND AD_Language='es_AR'
;

-- 29/11/2018 15:56:48 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element SET ColumnName='PorcDiferenciaValoracion', Name='Porc. Dif. de Valoración', PrintName='Porc. Dif. de Valoración',Updated=TO_DATE('2018-11-29 15:56:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000981
;
...
-- 29/11/2018 15:56:48 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_PrintFormatItem pi SET PrintName='Porc. Dif. de Valoración', Name='Porc. Dif. de Valoración' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3000981)
;

-- 29/11/2018 15:56:55 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element_Trl SET Name='Porc. Dif. de Valoración',PrintName='Porc. Dif. de Valoración',Updated=TO_DATE('2018-11-29 15:56:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000981 AND AD_Language='es_AR'
;

-- 29/11/2018 15:57:10 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column_Trl SET Name='Porc. Dif. de Valoración',Updated=TO_DATE('2018-11-29 15:57:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003363 AND AD_Language='es_AR'
;

-- 29/11/2018 16:12:53 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='((CurrencyRate (100, 118, LAR_PaymentHeader.DateTrx, (SELECT bp.C_ConversionType_ID FROM C_BPartner bp WHERE bp.C_BPartner_ID = LAR_PaymentHeader.C_BPartner_ID), LAR_PaymentHeader.AD_Client_ID, LAR_PaymentHeader.AD_Org_ID) - LAR_PaymentHeader.TasaDeCambio) * 100 / COALESCE (LAR_PaymentHeader.TasaDeCambio, 100))',Updated=TO_DATE('2018-11-29 16:12:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003363
;

-- 29/11/2018 16:43:57 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='((CurrencyRate (100, 118, LAR_PaymentHeader.DateTrx, (SELECT bp.C_ConversionType_ID FROM C_BPartner bp WHERE bp.C_BPartner_ID = LAR_PaymentHeader.C_BPartner_ID), LAR_PaymentHeader.AD_Client_ID, LAR_PaymentHeader.AD_Org_ID) - LAR_PaymentHeader.TasaDeCambio) * 100 / CASE LAR_PaymentHeader.TasaDeCambio > 0 THEN LAR_PaymentHeader.TasaCambio ELSE 100)',Updated=TO_DATE('2018-11-29 16:43:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003363
;

-- 29/11/2018 16:48:41 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='((CurrencyRate (100, 118, LAR_PaymentHeader.DateTrx, (SELECT bp.C_ConversionType_ID FROM C_BPartner bp WHERE bp.C_BPartner_ID = LAR_PaymentHeader.C_BPartner_ID), LAR_PaymentHeader.AD_Client_ID, LAR_PaymentHeader.AD_Org_ID) - LAR_PaymentHeader.TasaDeCambio) * 100 / CASE WHEN LAR_PaymentHeader.TasaDeCambio > 0 THEN LAR_PaymentHeader.TasaCambio ELSE 100 END)',Updated=TO_DATE('2018-11-29 16:48:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003363
;

-- 29/11/2018 16:50:02 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='((CurrencyRate (100, 118, LAR_PaymentHeader.DateTrx, (SELECT bp.C_ConversionType_ID FROM C_BPartner bp WHERE bp.C_BPartner_ID = LAR_PaymentHeader.C_BPartner_ID), LAR_PaymentHeader.AD_Client_ID, LAR_PaymentHeader.AD_Org_ID) - LAR_PaymentHeader.TasaDeCambio) * 100 / CASE WHEN LAR_PaymentHeader.TasaDeCambio > 0 THEN LAR_PaymentHeader.TasaDeCambio ELSE 100 END)',Updated=TO_DATE('2018-11-29 16:50:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003363
;

-- 29/11/2018 16:52:26 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Field SET IsCentrallyMaintained='N', IsReadOnly='Y',Updated=TO_DATE('2018-11-29 16:52:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006245
;

-- 29/11/2018 16:52:29 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Field_Trl SET IsTranslated='Y',Updated=TO_DATE('2018-11-29 16:52:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006245 AND AD_Language='es_AR'
;

-- 29/11/2018 16:52:45 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_DATE('2018-11-29 16:52:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005877
;
...
-- ISSUE #80: Cierre de Cajas.
INSERT INTO AD_Val_Rule (Type,AD_Val_Rule_ID,EntityType,Name,CreatedBy,UpdatedBy,Updated,AD_Client_ID,IsActive,AD_Org_ID,Created) VALUES ('S',3000066,'LAR','C_ConversionType',100,100,TO_DATE('2018-12-05 18:29:20','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,TO_DATE('2018-12-05 18:29:20','YYYY-MM-DD HH24:MI:SS'))
;

-- 05/12/2018 18:30:51 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Val_Rule SET Code='IsDefault = ''N''',Updated=TO_DATE('2018-12-05 18:30:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=3000066
;

-- 05/12/2018 18:35:20 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET AD_Val_Rule_ID=3000066,Updated=TO_DATE('2018-12-05 18:35:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002966
;

-- Registración de script
SELECT register_migration_script_lar('0122_ISSUE-114.sql', 'LAR', '') FROM dual
;
