...
UPDATE AD_Column SET MandatoryLogic='@WriteOffAmt@>0',Updated=TO_DATE('2012-07-29 09:35:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000820
;

-- 29/07/2012 9:35:40 ART
-- Add mandatory logic to C_TaxWithholding_id y WithholdingcertNo
UPDATE AD_Column SET MandatoryLogic='@WriteOffAmt@>0',Updated=TO_DATE('2012-07-29 09:35:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000816
;

-- 29/07/2012 10:42:45 ART
-- Do not display Remaining Amount if the invoice is processed
UPDATE AD_Field SET DisplayLogic='@C_Invoice_ID@>0 & @Processed@=N',Updated=TO_DATE('2012-07-29 10:42:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000602
;
