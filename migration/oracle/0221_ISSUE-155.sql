...
-- ISSUE #155: RRHH
INSERT INTO AD_SysConfig (AD_SysConfig_ID,EntityType,ConfigurationLevel,Value,Description,Name,AD_Client_ID,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy,IsActive) VALUES (3000083,'LAR','C','4000003','C_Remuneration_ID de DiffSAC','LAR_DiffSAC_C_Remuneration_ID',1000000,0,TO_DATE('2023-07-15 14:19:53','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2023-07-15 14:19:53','YYYY-MM-DD HH24:MI:SS'),100,100,'Y')
;

-- 15/07/2023 14:20:56 ART
-- ISSUE #155: RRHH
INSERT INTO AD_SysConfig (AD_SysConfig_ID,EntityType,ConfigurationLevel,Value,Description,Name,AD_Client_ID,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy,IsActive) VALUES (3000084,'LAR','C','4000002','C_Remuneration_ID de Diferencia Sueldo','LAR_Diff_C_Remuneration_ID',1000000,0,TO_DATE('2023-07-15 14:20:56','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2023-07-15 14:20:56','YYYY-MM-DD HH24:MI:SS'),100,100,'Y')
;

-- 15/07/2023 14:38:53 ART
-- ISSUE #155: RRHH
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001396,'totalramt','LAR','totalramt','totalramt',0,TO_DATE('2023-07-15 14:38:53','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2023-07-15 14:38:53','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- ISSUE #155: RRHH
UPDATE AD_Element SET ColumnName='TotalRAmt', Name='TotalRAmt',Updated=TO_DATE('2023-07-15 14:39:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001396
;
...
-- 15/07/2023 14:39:17 ART
-- ISSUE #155: RRHH
UPDATE AD_PrintFormatItem pi SET PrintName='totalramt', Name='TotalRAmt' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001396)
;

-- 15/07/2023 14:39:31 ART
-- ISSUE #155: RRHH
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Remuneración Total',PrintName='Remuneración Total',Updated=TO_DATE('2023-07-15 14:39:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001396 AND AD_Language='es_AR'
;

-- 15/07/2023 14:40:00 ART
-- ISSUE #155: RRHH
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3008815,14,'Y','N','N',3005578,'N','Y',727,'N','LAR','TotalRAmt',100,0,TO_DATE('2023-07-15 14:40:00','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_DATE('2023-07-15 14:40:00','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #155: RRHH
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2023-07-15 14:40:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3008815
;

-- Registración de script
SELECT register_migration_script_lar('0221_ISSUE-155.sql', 'LAR', '') FROM dual
;
