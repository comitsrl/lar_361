...
-- Add ergio Payment Terms
INSERT INTO C_PaymentTerm (IsDefault,DiscountDays2,Discount2,AfterDelivery,C_PaymentTerm_ID,GraceDays,NetDays,Discount,DiscountDays,IsDueFixed,IsNextBusinessDay,IsValid,PaymentTermUsage,Name,Value,CreatedBy,Updated,UpdatedBy,AD_Org_ID,IsActive,Processing,Created,AD_Client_ID) VALUES ('Y',0,0,'N',3000001,0,0,0,0,'N','N','Y','B','Contado','CO',100,TO_DATE('2012-06-08 11:30:47','YYYY-MM-DD HH24:MI:SS'),100,0,'Y','N',TO_DATE('2012-06-08 11:30:47','YYYY-MM-DD HH24:MI:SS'),1000000)
;
