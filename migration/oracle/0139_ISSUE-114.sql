...
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003530,390,'LAR',0,'Y','N','N','N',131089,'N',22,'N',3000867,'N','Y','N','Tasa de Cambio','TasaDeCambio',100,TO_DATE('2019-09-27 19:04:27','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2019-09-27 19:04:27','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Tasa de Cambio en Asignaciones.
UPDATE AD_Column SET FieldLength=20,Updated=TO_DATE('2019-09-27 19:04:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003530
;

-- 27/09/2019 19:05:21 ART
-- ISSUE #114: Tasa de Cambio en Asignaciones.
UPDATE AD_Column SET AD_Reference_ID=37,Updated=TO_DATE('2019-09-27 19:05:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003530
;

-- 27/09/2019 19:10:56 ART
-- ISSUE #114: Tasa de Cambio en Asignaciones.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3006612,20,'Y','N','N',3003530,'N','Y',349,'N','LAR','Tasa de Cambio',100,0,TO_DATE('2019-09-27 19:10:56','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2019-09-27 19:10:56','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Tasa de Cambio en Asignaciones.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2019-09-27 19:11:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006612
;

-- Registración de script
SELECT register_migration_script_lar('0139_ISSUE-114.sql', 'LAR', '') FROM dual
;
