...
-- Add fiscal printing code to Process_Invoice WF
INSERT INTO AD_WF_NodeNext (EntityType,IsStdUserWorkflow,AD_WF_NodeNext_ID,AD_WF_Node_ID,SeqNo,AD_WF_Next_ID,Created,CreatedBy,UpdatedBy,AD_Org_ID,IsActive,Updated,AD_Client_ID) VALUES ('LAR','N',3000000,194,10,3000000,TO_DATE('2012-04-26 17:11:31','YYYY-MM-DD HH24:MI:SS'),100,100,0,'Y',TO_DATE('2012-04-26 17:11:31','YYYY-MM-DD HH24:MI:SS'),0)
;
