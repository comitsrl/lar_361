...
-- 14/05/2012 10:53:06 ART
-- Add payment doctype to POS
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3000277,748,'LAR',0,'N','N','N','N',10,'N',19,'N',3000087,'N','Y','N','c_payment_doctype_id','c_payment_doctype_id',100,TO_DATE('2012-05-14 10:53:05','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2012-05-14 10:53:05','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Add payment doctype to POS
UPDATE AD_Element SET ColumnName='C_Payment_DocType_ID', Name='C_Payment_DocType_ID', PrintName='C_Payment_DocType_ID',Updated=TO_DATE('2012-05-14 10:54:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000087
;
...
-- 14/05/2012 10:54:22 ART
-- Add payment doctype to POS
UPDATE AD_PrintFormatItem pi SET PrintName='C_Payment_DocType_ID', Name='C_Payment_DocType_ID' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3000087)
;

-- 14/05/2012 10:55:27 ART
-- Add payment doctype to POS
UPDATE AD_Column SET AD_Reference_Value_ID=170, IsMandatory='Y', AD_Reference_ID=18,Updated=TO_DATE('2012-05-14 10:55:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000277
;

-- 14/05/2012 11:00:17 ART
-- Add payment doctype to POS
UPDATE AD_Column SET IsMandatory='Y', AD_Val_Rule_ID=3000004,Updated=TO_DATE('2012-05-14 11:00:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=54236
;

-- 14/05/2012 11:11:44 ART
-- Add payment doctype to POS
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_DATE('2012-05-14 11:11:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=12795
;

-- 14/05/2012 11:11:58 ART
-- Add payment doctype to POS
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3000742,10,'Y','N','N',3000277,'N','Y',676,'N','LAR','C_Payment_DocType_ID',100,0,TO_DATE('2012-05-14 11:11:58','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_DATE('2012-05-14 11:11:58','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2012-05-14 11:14:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000742
;

-- 14/05/2012 11:14:32 ART
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2012-05-14 11:14:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10810
;

-- 14/05/2012 11:15:09 ART
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2012-05-14 11:15:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10798
;

-- 14/05/2012 11:15:14 ART
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2012-05-14 11:15:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=58808
;

-- 14/05/2012 11:15:17 ART
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2012-05-14 11:15:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=58809
;

-- 14/05/2012 11:15:30 ART
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2012-05-14 11:15:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=58810
;

-- 14/05/2012 11:15:35 ART
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2012-05-14 11:15:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10803
;
...
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2012-05-14 11:22:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000085
;

-- 14/05/2012 11:22:36 ART
-- Add payment doctype to POS
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2012-05-14 11:22:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000087
;

-- 14/05/2012 11:28:01 ART
-- Add payment doctype to POS
UPDATE AD_Column SET AD_Val_Rule_ID=3000001,Updated=TO_DATE('2012-05-14 11:28:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000277
;
