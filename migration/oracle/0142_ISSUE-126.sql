...
INSERT INTO C_Charge (IsSameCurrency,IsSameTax,C_TaxCategory_ID,ChargeAmt,C_Charge_ID,IsTaxIncluded,Name,AD_Org_ID,CreatedBy,IsActive,Created,UpdatedBy,Updated,AD_Client_ID) VALUES ('N','N',1000001,0,4000002,'N','Desc. Financiero por Pago',1000000,100,'Y',TO_DATE('2019-10-31 15:28:30','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2019-10-31 15:28:30','YYYY-MM-DD HH24:MI:SS'),1000000)
;
...
-- 31/10/2019 15:28:30 ART
-- ISSUE #126: Generar Nota de Crédito automatica, al completar recibo con descuento.
INSERT INTO C_Charge_Acct (C_Charge_ID, C_AcctSchema_ID, AD_Client_ID,AD_Org_ID,IsActive, Created,CreatedBy,Updated,UpdatedBy ,Ch_Expense_Acct,Ch_Revenue_Acct) SELECT 4000002, p.C_AcctSchema_ID, p.AD_Client_ID,0,'Y', SysDate,100,SysDate,100,p.Ch_Expense_Acct,p.Ch_Revenue_Acct FROM C_AcctSchema_Default p WHERE p.AD_Client_ID=1000000 AND NOT EXISTS (SELECT * FROM C_Charge_Acct e WHERE e.C_AcctSchema_ID=p.C_AcctSchema_ID AND e.C_Charge_ID=4000002)
;

-- 31/10/2019 15:30:09 ART
-- ISSUE #126: Generar Nota de Crédito automatica, al completar recibo con descuento.
INSERT INTO AD_SysConfig (AD_SysConfig_ID,EntityType,ConfigurationLevel,Value,Description,Name,Created,Updated,AD_Client_ID,AD_Org_ID,CreatedBy,UpdatedBy,IsActive) VALUES (3000053,'LAR','C','4000002','Ingresar el ID del cargo a utilizar, en Nota de Crédito Automatica en Recibos con descuentos.','LAR_CargoNCAutomatica_Recibo',TO_DATE('2019-10-31 15:30:08','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2019-10-31 15:30:08','YYYY-MM-DD HH24:MI:SS'),1000000,0,100,100,'Y')
;

-- 31/10/2019 15:36:59 ART
-- ISSUE #126: Generar Nota de Crédito automatica, al completar recibo con descuento.
INSERT INTO AD_SysConfig (AD_SysConfig_ID,EntityType,ConfigurationLevel,Value,Description,Name,Created,Updated,AD_Client_ID,AD_Org_ID,CreatedBy,UpdatedBy,IsActive) VALUES (3000054,'LAR','C','A','Ingresar la letra G, si se desea generar la Nota de Crédito automática. Ingresar P, si ademas de generar la NC, se desea procesarla. Ingresar A, para generar la NC, procesarla y asignarla a la factura con descuento. Para desactivar ingrese, D. ','LAR_GenerarNC_EnRecibos',TO_DATE('2019-10-31 15:36:59','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2019-10-31 15:36:59','YYYY-MM-DD HH24:MI:SS'),1000000,0,100,100,'Y')
;

-- 31/10/2019 18:03:30 ART
-- ISSUE #126: Generar Nota de Crédito automatica, al completar recibo con descuento.
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_DATE('2019-10-31 18:03:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000321
;
