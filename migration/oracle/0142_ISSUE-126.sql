...
INSERT INTO C_Charge (IsSameCurrency,IsSameTax,C_TaxCategory_ID,ChargeAmt,C_Charge_ID,IsTaxIncluded,Name,AD_Org_ID,CreatedBy,IsActive,Created,UpdatedBy,Updated,AD_Client_ID) VALUES ('N','N',1000001,0,1000002,'N','Desc. Financiero por Pago',1000000,100,'Y',TO_DATE('2019-10-31 15:28:30','YYYY-MM-DD HH24:MI:SS'),100,TO_DATE('2019-10-31 15:28:30','YYYY-MM-DD HH24:MI:SS'),1000000)
;
...
-- ISSUE #126: Generar Nota de Crédito automatica, al completar recibo con descuento.
INSERT INTO AD_SysConfig (AD_SysConfig_ID,EntityType,ConfigurationLevel,Value,Description,Name,Created,Updated,AD_Client_ID,AD_Org_ID,CreatedBy,UpdatedBy,IsActive) VALUES (3000053,'LAR','C','1000002','Ingresar el ID del cargo a utilizar, en Nota de Crédito Automatica en Recibos con descuentos.','LAR_CargoNCAutomatica_Recibo',TO_DATE('2019-10-31 15:30:08','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2019-10-31 15:30:08','YYYY-MM-DD HH24:MI:SS'),1000000,0,100,100,'Y')
;
