...
ALTER TABLE LAR_LOTESUELDOS ADD LAR_TipoLiquidacion VARCHAR2(3);

ALTER TABLE LAR_LOTESUELDOS MODIFY LAR_TipoLiquidacion DEFAULT '001';

ALTER TABLE LAR_LOTESUELDOS ADD CONSTRAINT LAR_LOTESUELDOS_TIPOLIQ_CHK CHECK (LAR_TipoLiquidacion IN ('001','002'));

-- 2) Banco pagador: numero de empresa/convenio 
ALTER TABLE C_BANK ADD LAR_NroEmpresa NUMBER(4,0);

ALTER TABLE C_BANK ADD CONSTRAINT C_BANK_NROEMPRESA_CHK CHECK (LAR_NroEmpresa IS NULL OR LAR_NroEmpresa BETWEEN 1 AND 8999);

-- 3) Cuenta bancaria de acreditacion: codigo de dependencia 
ALTER TABLE C_BANKACCOUNT ADD LAR_CodigoDependencia VARCHAR2(15);

ALTER TABLE C_BANKACCOUNT ADD CONSTRAINT C_BANKACCOUNT_CODIGODEP_CHK CHECK (LAR_CodigoDependencia IS NULL OR REGEXP_LIKE(LAR_CodigoDependencia, '^[0-9]{1,15}$'));

-- 23/02/2026 10:45:41 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001534,'lar_tipoliquidacion','LAR','lar_tipoliquidacion','lar_tipoliquidacion',0,TO_DATE('2026-02-23 10:45:41','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2026-02-23 10:45:41','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- 23/02/2026 10:45:41 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3005953,3000278,'LAR',0,'N','N','N','N',3,'N',10,'N',3001534,'N','Y','N','lar_tipoliquidacion','lar_tipoliquidacion',100,TO_DATE('2026-02-23 10:45:41','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2026-02-23 10:45:41','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Element SET ColumnName='LAR_TipoLiquidacion', Name='LAR_TipoLiquidacion', PrintName='LAR_TipoLiquidacion',Updated=TO_DATE('2026-02-23 10:46:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001534
;
...
-- 23/02/2026 10:46:41 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_PrintFormatItem pi SET PrintName='LAR_TipoLiquidacion', Name='LAR_TipoLiquidacion' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001534)
;

-- 23/02/2026 10:47:14 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Tipo Liquidación',PrintName='Tipo Liquidación',Description='Tipo Liquidación, Sueldos Mensuales o SAC',Updated=TO_DATE('2026-02-23 10:47:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001534 AND AD_Language='es_AR'
;

-- 23/02/2026 10:48:31 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Reference (AD_Reference_ID,ValidationType,VFormat,EntityType,IsOrderByValue,Name,Description,AD_Client_ID,AD_Org_ID,CreatedBy,Updated,IsActive,Created,UpdatedBy) VALUES (3000181,'L','L','LAR','N','Tipo Liquidación','Tipo Liquidación: SAC, Sueldos Mensuales',0,0,100,TO_DATE('2026-02-23 10:48:31','YYYY-MM-DD HH24:MI:SS'),'Y',TO_DATE('2026-02-23 10:48:31','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Ref_List (AD_Ref_List_ID,AD_Reference_ID,EntityType,Description,Value,Name,Updated,Created,CreatedBy,UpdatedBy,AD_Org_ID,IsActive,AD_Client_ID) VALUES (3000381,3000181,'LAR','Sueldos Mensuales','001','Sueldo',TO_DATE('2026-02-23 10:50:35','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2026-02-23 10:50:35','YYYY-MM-DD HH24:MI:SS'),100,100,0,'Y',0)
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Ref_List SET Description='Sueldo Mensual',Updated=TO_DATE('2026-02-23 10:50:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=3000381
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Ref_List_Trl SET Description='Sueldos Mensual',Updated=TO_DATE('2026-02-23 10:51:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=3000381 AND AD_Language='es_AR'
;

-- 23/02/2026 10:54:05 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Reference SET Name='RRHH Tipo Liquidación',Updated=TO_DATE('2026-02-23 10:54:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=3000181
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Ref_List SET EntityType='LAR', Description='Sueldo Anual Complementario',Updated=TO_DATE('2026-02-23 10:54:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=3000382
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Ref_List_Trl SET Description='Sueldo Anual Complementario',Updated=TO_DATE('2026-02-23 10:54:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=3000382 AND AD_Language='es_AR'
;

-- 23/02/2026 10:54:33 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Column SET AD_Reference_Value_ID=3000181, AD_Reference_ID=17,Updated=TO_DATE('2026-02-23 10:54:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005953
;

-- 23/02/2026 10:54:52 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Column SET IsMandatory='Y', IsAlwaysUpdateable='Y',Updated=TO_DATE('2026-02-23 10:54:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005953
;

-- 23/02/2026 10:55:29 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009474,3,'Y','N','N',3005953,'N','Y',3000315,'N','LAR','LAR_TipoLiquidacion',100,0,TO_DATE('2026-02-23 10:55:29','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2026-02-23 10:55:29','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 23/02/2026 10:55:57 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3005954,296,'LAR',0,'N','N','N','N',4,'N',22,'N',3001535,'N','Y','N','lar_nroempresa','lar_nroempresa',100,TO_DATE('2026-02-23 10:55:57','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2026-02-23 10:55:57','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Element SET ColumnName='LAR_NroEmpresa', Name='LAR_NroEmpresa', PrintName='LAR_NroEmpresa',Updated=TO_DATE('2026-02-23 10:56:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001535
;
...
-- 23/02/2026 10:56:22 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_PrintFormatItem pi SET PrintName='LAR_NroEmpresa', Name='LAR_NroEmpresa' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001535)
;

-- 23/02/2026 10:56:43 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Nro. Empresa',PrintName='Número de Empresa otorgado por el Banco.',Updated=TO_DATE('2026-02-23 10:56:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001535 AND AD_Language='es_AR'
;

-- 23/02/2026 10:57:18 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Column SET AD_Reference_ID=10, Name='LAR_NroEmpresa', ColumnName='LAR_NroEmpresa',Updated=TO_DATE('2026-02-23 10:57:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005954
;

-- 23/02/2026 10:57:36 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009475,4,'Y','N','N',3005954,'N','Y',227,'N','LAR','LAR_NroEmpresa',100,0,TO_DATE('2026-02-23 10:57:36','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2026-02-23 10:57:36','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001536,'lar_codigodependencia','LAR','lar_codigodependencia','lar_codigodependencia',0,TO_DATE('2026-02-23 10:58:05','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2026-02-23 10:58:05','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- 23/02/2026 10:58:05 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3005955,297,'LAR',0,'N','N','N','N',15,'N',10,'N',3001536,'N','Y','N','lar_codigodependencia','lar_codigodependencia',100,TO_DATE('2026-02-23 10:58:05','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2026-02-23 10:58:05','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Element SET ColumnName='LAR_CodigoDependencia', Name='LAR_CodigoDependencia', PrintName='LAR_CodigoDependencia',Updated=TO_DATE('2026-02-23 10:58:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001536
;
...
-- 23/02/2026 10:58:31 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_PrintFormatItem pi SET PrintName='LAR_CodigoDependencia', Name='LAR_CodigoDependencia' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001536)
;

-- 23/02/2026 10:58:48 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Codigo Dependencia',PrintName='Codigo Dependencia',Description='Codigo Dependencia Bancaria',Updated=TO_DATE('2026-02-23 10:58:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001536 AND AD_Language='es_AR'
;

-- 23/02/2026 10:59:27 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009476,15,'Y','N','N',3005955,'N','Y',228,'N','LAR','LAR_CodigoDependencia',100,0,TO_DATE('2026-02-23 10:59:27','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2026-02-23 10:59:27','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Fecha Presentacion ',Updated=TO_DATE('2026-02-27 10:26:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=3001151 AND AD_Language='es_AR'
;

-- 27/02/2026 10:26:38 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Process_Para (IsRange,AD_Process_Para_ID,FieldLength,AD_Process_ID,CreatedBy,IsCentrallyMaintained,AD_Reference_ID,SeqNo,IsMandatory,DefaultValue,EntityType,Name,ColumnName,IsActive,AD_Client_ID,UpdatedBy,Updated,Created,AD_Org_ID,IsEncrypted) VALUES ('N',3001152,0,3000628,100,'N',15,20,'Y','@#Date@','LAR','FechaAcreditacion','FechaAcreditacion','Y',0,100,TO_DATE('2026-02-27 10:26:38','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2026-02-27 10:26:38','YYYY-MM-DD HH24:MI:SS'),0,'N')
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Fecha Acreditacion',Updated=TO_DATE('2026-02-27 10:26:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=3001152 AND AD_Language='es_AR'
;

-- 27/02/2026 10:27:25 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
INSERT INTO AD_Process_Para (IsRange,AD_Process_Para_ID,FieldLength,AD_Process_ID,CreatedBy,IsCentrallyMaintained,AD_Reference_ID,SeqNo,IsMandatory,DefaultValue,EntityType,Name,ColumnName,IsActive,AD_Client_ID,UpdatedBy,Updated,Created,AD_Org_ID,IsEncrypted) VALUES ('N',3001153,0,3000628,100,'N',10,30,'Y','01','LAR','NroEnvio','NroEnvio','Y',0,100,TO_DATE('2026-02-27 10:27:25','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2026-02-27 10:27:25','YYYY-MM-DD HH24:MI:SS'),0,'N')
;
...
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Nro. Envío',Updated=TO_DATE('2026-02-27 10:27:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=3001153 AND AD_Language='es_AR'
;

-- 27/02/2026 10:43:33 ART
-- ISSUE #155: Lote Sueldos - Exportación para Banco
UPDATE AD_Column SET AD_Process_ID=3000628, IsAlwaysUpdateable='Y',Updated=TO_DATE('2026-02-27 10:43:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005899
;
...
SELECT register_migration_script_lar('0245_ISSUE-155.sql', 'LAR', '') FROM dual
;
