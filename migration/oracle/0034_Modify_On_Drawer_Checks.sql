...
ALTER TABLE C_Payment ADD TargetAccount		VARCHAR2(60);
ALTER TABLE C_Payment ADD isbounced 			Char(1) DEFAULT 'N' NULL;
ALTER TABLE C_Payment ADD isdeposited 		Char(1) DEFAULT 'N' NULL;
...
-- On drawer Checks, new columns and fields
UPDATE AD_Tab SET WhereClause='IsReceipt=''Y'' AND TenderType=''K'' AND IsReconciled=''N'' AND Docstatus NOT IN (''DR'', ''VO'', ''RE'')',Updated=TO_DATE('2012-09-10 07:16:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000018
;
