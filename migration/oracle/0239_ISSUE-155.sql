ALTER TABLE AD_Role
ADD IgnoraLimiteAdelantos CHAR(1) DEFAULT 'N' NOT NULL;

-- 31/10/2025 14:29:04 ART
-- ISSUE #155: Lote Pago de Sueldos
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001521,'ignoralimiteadelantos','LAR','ignoralimiteadelantos','ignoralimiteadelantos',0,TO_DATE('2025-10-31 14:29:03','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2025-10-31 14:29:03','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- ISSUE #155: Lote Pago de Sueldos
UPDATE AD_Element SET ColumnName='IgnoraLimiteAdelantos', Name='IgnoraLimiteAdelantos', PrintName='IgnoraLimiteAdelantos',Updated=TO_DATE('2025-10-31 14:29:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001521
;
...
-- 31/10/2025 14:29:36 ART
-- ISSUE #155: Lote Pago de Sueldos
UPDATE AD_PrintFormatItem pi SET PrintName='IgnoraLimiteAdelantos', Name='IgnoraLimiteAdelantos' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001521)
;

-- 31/10/2025 14:29:59 ART
-- ISSUE #155: Lote Pago de Sueldos
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Ignora Límite Adelantos',PrintName='Ignora Límite Adelantos',Updated=TO_DATE('2025-10-31 14:29:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001521 AND AD_Language='es_AR'
;

-- 31/10/2025 14:36:10 ART
-- ISSUE #155: Lote Pago de Sueldos
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009453,1,'Y','N','N',3005919,'N','Y',119,'N','LAR','IgnoraLimiteAdelantos',100,0,TO_DATE('2025-10-31 14:36:10','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2025-10-31 14:36:10','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #155: Lote Pago de Sueldos
UPDATE AD_Column SET DefaultValue='@#AD_Org_ID@', IsAllowCopy='N',Updated=TO_DATE('2025-10-31 19:38:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005859
;

-- 31/10/2025 19:56:18 ART
-- ISSUE #155: Lote Pago de Sueldos
INSERT INTO AD_SysConfig (AD_SysConfig_ID,EntityType,ConfigurationLevel,Value,Description,Name,AD_Client_ID,AD_Org_ID,Created,Updated,CreatedBy,UpdatedBy,IsActive) VALUES (3000090,'LAR','C','','IDs de los SdNs (empleados) excluidos de la recuperación de sueldos por lote (Valores separados por coma).','LAR_SdNsExcluidosRRHH',1000000,0,TO_DATE('2025-10-31 19:56:17','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2025-10-31 19:56:17','YYYY-MM-DD HH24:MI:SS'),100,100,'Y')
;

-- 11/11/2025 9:24:26 ART
-- ISSUE #155: Lote Pago de Sueldos
UPDATE AD_Column SET AD_Val_Rule_ID=52033,Updated=TO_DATE('2025-11-11 09:24:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=4021
;

-- Registración de script
SELECT register_migration_script_lar('0239_ISSUE-155.sql', 'LAR', '') FROM dual
;
