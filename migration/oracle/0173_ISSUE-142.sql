...
-- ISSUE #142: Validaciones en ventana Entrega Cliente.
UPDATE AD_Val_Rule SET Code='C_OrderLine.C_Order_ID=@C_Order_ID@ AND C_OrderLine.QtyOrdered != C_OrderLine.QtyDelivered',Updated=TO_DATE('2021-05-19 19:54:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=203
;
