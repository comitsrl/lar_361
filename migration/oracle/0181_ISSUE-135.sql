...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Column SET MandatoryLogic='@OrderType@=''WI''',Updated=TO_DATE('2021-06-23 19:12:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001210
;

-- 23/06/2021 19:13:05 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Field SET DisplayLogic='@OrderType@=''WI''',Updated=TO_DATE('2021-06-23 19:13:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3002015
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Field SET SeqNo=105, DisplayLogic='@OrderType@=''WI''',Updated=TO_DATE('2021-06-23 19:13:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007116
;

-- 23/06/2021 19:16:06 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Field SET SeqNo=115,Updated=TO_DATE('2021-06-23 19:16:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007116
;
