...
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Column SET Name='Cancelación', ColumnName='Cancelacion',Updated=TO_DATE('2019-07-26 15:30:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003522
;
...
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Column_Trl SET Name='Cancelación',Updated=TO_DATE('2019-07-26 15:30:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003522 AND AD_Language='es_AR'
;

-- 26/07/2019 15:30:35 ART
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Element SET ColumnName='Cancelacion', Name='Cancelación', PrintName='Cancelación',Updated=TO_DATE('2019-07-26 15:30:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001039
;
...
-- 26/07/2019 15:30:35 ART
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_PrintFormatItem pi SET PrintName='Cancelación', Name='Cancelación' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001039)
;

-- 26/07/2019 15:30:43 ART
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Element_Trl SET Name='Cancelación',PrintName='Cancelación',Updated=TO_DATE('2019-07-26 15:30:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001039 AND AD_Language='es_AR'
;

-- 26/07/2019 15:32:51 ART
-- ISSUE #77: Factura de Credito Electronica (FCE).
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3006572,1,'Y','N','N',3003522,'N','Y',263,'N','LAR','Cancelación',100,0,TO_DATE('2019-07-26 15:32:50','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2019-07-26 15:32:50','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2019-07-26 15:41:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006572
;
...
-- 26/07/2019 17:27:30 ART
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Field SET DisplayLogic='@TargetDocBaseType@=''ARC'' & @DocSubTypeCAE@ = 203 | @DocSubTypeCAE@ = 208 | @DocSubTypeCAE@ = 213',Updated=TO_DATE('2019-07-26 17:27:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006572
;

-- 26/07/2019 17:32:23 ART
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Field SET DisplayLogic='@TargetDocBaseType@=''ARC'' | @DocSubTypeCAE@=202 | @DocSubTypeCAE@=207 | @DocSubTypeCAE@=212',Updated=TO_DATE('2019-07-26 17:32:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000603
;

-- 26/07/2019 17:34:54 ART
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Field_Trl SET Name='Cancelación FCE',Updated=TO_DATE('2019-07-26 17:34:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006572 AND AD_Language='es_AR'
;

-- 26/07/2019 17:35:06 ART
-- ISSUE #77: Factura de Credito Electronica (FCE).
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_DATE('2019-07-26 17:35:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3006572
;

-- Registración de script
SELECT register_migration_script_lar('0133_ISSUE-77.sql', 'LAR', '') FROM dual
;
