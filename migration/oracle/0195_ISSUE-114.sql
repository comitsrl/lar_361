...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001186,'esdiferenciacambio','LAR','esdiferenciacambio','esdiferenciacambio',0,TO_DATE('2021-09-13 16:37:47','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2021-09-13 16:37:47','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
UPDATE AD_Column SET Name='Es Diferencia de Cambio', ColumnName='EsDiferenciaCambio',Updated=TO_DATE('2021-09-13 16:39:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004183
;
...
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
UPDATE AD_Column_Trl SET Name='Es Diferencia de Cambio',Updated=TO_DATE('2021-09-13 16:39:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004183 AND AD_Language='es_AR'
;

-- 13/09/2021 16:39:34 ART
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
UPDATE AD_Element SET ColumnName='EsDiferenciaCambio', Name='Es Diferencia de Cambio', PrintName='Es Diferencia de Cambio',Updated=TO_DATE('2021-09-13 16:39:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001186
;
...
-- 13/09/2021 16:39:34 ART
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
UPDATE AD_PrintFormatItem pi SET PrintName='Es Diferencia de Cambio', Name='Es Diferencia de Cambio' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001186)
;

-- 13/09/2021 16:39:42 ART
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
UPDATE AD_Element_Trl SET Name='Es Diferencia de Cambio',PrintName='Es Diferencia de Cambio',Updated=TO_DATE('2021-09-13 16:39:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001186 AND AD_Language='es_AR'
;

-- 13/09/2021 16:43:29 ART
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007397,1,'Y','N','N',3004183,3000013,'N','Y','N','LAR','Es Diferencia de Cambio',100,0,TO_DATE('2021-09-13 16:43:29','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2021-09-13 16:43:29','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2021-09-13 16:47:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007397
;

-- 13/09/2021 16:53:34 ART
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007398,10,'Y','N','N',3003929,3000016,'N','Y','N','LAR','Billetera Digital',100,0,TO_DATE('2021-09-13 16:53:34','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2021-09-13 16:53:34','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007399,1,'Y','N','N',3004183,3000016,'N','Y','N','LAR','Es Diferencia de Cambio',100,0,TO_DATE('2021-09-13 16:53:34','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2021-09-13 16:53:34','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Cobro/Pago por diferencia de cambio.
UPDATE AD_Field SET AD_FieldGroup_ID=125,Updated=TO_DATE('2021-09-13 16:56:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007399
;

-- Registración de script
SELECT register_migration_script_lar('0195_ISSUE-114.sql', 'LAR', '') FROM dual
;
