...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001519,'esdevolucion','LAR','esdevolucion','esdevolucion',0,TO_DATE('2025-09-19 13:13:05','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2025-09-19 13:13:05','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- 19/09/2025 13:13:06 ART
-- ISSUE #80: Cierre de Cajas.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3005916,217,'LAR',0,'Y','N','N','N',1,'N',20,'N',3001519,'N','Y','N','esdevolucion','esdevolucion',100,TO_DATE('2025-09-19 13:13:05','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2025-09-19 13:13:05','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element SET ColumnName='EsDevolucion', Name='Es Devolución', PrintName='Es Devolución',Updated=TO_DATE('2025-09-19 13:13:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001519
;
...
-- 19/09/2025 13:13:53 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_PrintFormatItem pi SET PrintName='Es Devolución', Name='Es Devolución' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001519)
;

-- 19/09/2025 13:13:59 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element_Trl SET Name='Es Devolución',PrintName='Es Devolución',Updated=TO_DATE('2025-09-19 13:13:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001519 AND AD_Language='es_AR'
;

-- 19/09/2025 13:14:41 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column_Trl SET Name='Es Devolución',Updated=TO_DATE('2025-09-19 13:14:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005916 AND AD_Language='es_AR'
;

-- 19/09/2025 13:15:11 ART
-- ISSUE #80: Cierre de Cajas.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009450,1,'Y','N','N',3005916,'N','Y',167,'N','LAR','Es Devolución',100,0,TO_DATE('2025-09-19 13:15:11','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2025-09-19 13:15:11','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2025-09-19 13:16:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3009450
;

-- Registración de script
SELECT register_migration_script_lar('0240_ISSUE-173.sql', 'LAR', '') FROM dual
;
