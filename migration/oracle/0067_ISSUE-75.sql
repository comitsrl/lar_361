...
-- ISSUE #75: Orden de Nota de Crédito
INSERT INTO AD_WF_Node (AD_WF_Node_ID,Cost,DynPriorityChange,WaitTime,Priority,DocAction,Duration,EntityType,IsCentrallyMaintained,JoinElement,Limit,WorkingTime,XPosition,YPosition,WaitingTime,AD_Process_ID,AD_Workflow_ID,Action,SplitElement,Value,Name,UpdatedBy,AD_Org_ID,Created,CreatedBy,IsActive,Updated,AD_Client_ID) VALUES (3000016,0,0,0,0,'CO',0,'LAR','Y','X',0,0,0,0,0,3000109,116,'P','X','(DocInvFiscalPrinting)','LAR_OrdertFiscalPrinting',100,0,TO_DATE('2016-01-06 23:07:20','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2016-01-06 23:07:20','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- ISSUE #75: Orden de Nota de Crédito
INSERT INTO AD_Ref_Table (IsValueDisplayed,WhereClause,AD_Table_ID,AD_Reference_ID,AD_Key,AD_Display,EntityType,CreatedBy,Created,Updated,AD_Client_ID,UpdatedBy,AD_Org_ID,IsActive) VALUES ('N','C_Order.IsSoTrx = ''Y''',259,3000039,2161,2161,'LAR',100,TO_DATE('2016-01-07 00:04:02','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2016-01-07 00:04:02','YYYY-MM-DD HH24:MI:SS'),0,100,0,'Y')
;

-- 07/01/2016 0:04:23 ART
-- ISSUE #75: Orden de Nota de Crédito
UPDATE AD_Column SET AD_Reference_Value_ID=3000039,Updated=TO_DATE('2016-01-07 00:04:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000888
;


-- Registración de script
SELECT register_migration_script_lar('0067_ISSUE-75.sql', 'LAR', '') FROM dual
;
