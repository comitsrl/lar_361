ALTER TABLE C_BankAccount_Acct
    ADD IsPosteable CHAR(1) DEFAULT 'Y' NOT NULL;

ALTER TABLE C_BankAccount_Acct
    ADD CONSTRAINT c_bankaccount_acct_isposteable_check CHECK (IsPosteable IN ('Y','N'));

-- 24/01/2026 9:13:17 ART
-- ISSUE #174: Funcionalidad Contable Argentina
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001532,'isposteable','LAR','isposteable','isposteable',0,TO_DATE('2026-01-24 09:13:16','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2026-01-24 09:13:16','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- ISSUE #174: Funcionalidad Contable Argentina
UPDATE AD_Element SET ColumnName='IsPosteable', Name='IsPosteable', PrintName='IsPosteable',Updated=TO_DATE('2026-01-24 09:15:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001532
;
...
-- 24/01/2026 9:15:11 ART
-- ISSUE #174: Funcionalidad Contable Argentina
UPDATE AD_PrintFormatItem pi SET PrintName='IsPosteable', Name='IsPosteable' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001532)
;

-- 24/01/2026 9:15:21 ART
-- ISSUE #174: Funcionalidad Contable Argentina
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Contabiliza',PrintName='Contabiliza',Updated=TO_DATE('2026-01-24 09:15:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001532 AND AD_Language='es_AR'
;

-- Registración de script
SELECT register_migration_script_lar('0244_ISSUE-174.sql', 'LAR', '') FROM dual
;
