...
UPDATE AD_Menu_Trl SET Name='Movimientos de Caja',Updated=TO_DATE('2016-11-14 19:18:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=3000183 AND AD_Language='es_AR'
;

-- 14/11/2016 19:19:25 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Window_Trl SET Name='Movimientos de Caja',Updated=TO_DATE('2016-11-14 19:19:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=3000063 AND AD_Language='es_AR'
;

-- 14/11/2016 19:20:46 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Tab_Trl SET Name='Movimiento de Caja',Updated=TO_DATE('2016-11-14 19:20:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000127 AND AD_Language='es_AR'
;

-- 14/11/2016 19:21:59 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Menu SET IsActive='N',Updated=TO_DATE('2016-11-14 19:21:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=3000007
;

-- 14/11/2016 19:25:06 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE C_DocType SET PrintName='Movimiento de Caja', Name='Movimiento de Caja',Updated=TO_DATE('2016-11-14 19:25:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=3000159
;
...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET IsMandatory='N', MandatoryLogic='@Retiro@=Y | @Transferencia@=Y',Updated=TO_DATE('2016-11-14 21:15:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001819
;

-- 25/11/2016 21:55:23 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='((SELECT (C_BankStatement.ScrutinizedCashAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType = ''X'')) + (SELECT (C_BankStatement.ScrutinizedCheckAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN (''Z'', ''K''))) + (SELECT (C_BankStatement.ScrutinizedCreditCardAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN (''D'', ''C'')))',Updated=TO_DATE('2016-11-25 21:55:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000161
;

-- 25/11/2016 21:57:52 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Val_Rule SET Code='C_BankAccount.IsDrawer=''Y'' AND C_BankAccount.IsActive=''Y''',Updated=TO_DATE('2016-11-25 21:57:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=3000034
;

-- 25/11/2016 22:04:33 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Val_Rule SET Code='(C_BankAccount.IsDrawer=''Y'' AND C_BankAccount.AD_Org_ID=@AD_Org_ID@ AND C_BankAccount.IsActive=''Y'')',Updated=TO_DATE('2016-11-25 22:04:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=3000004
;

-- 30/11/2016 19:48:21 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='((SELECT (C_BankStatement.ScrutinizedCashAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType = ''X'')) + (SELECT (C_BankStatement.ScrutinizedCheckAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN (''Z'', ''K''))) + (SELECT (C_BankStatement.ScrutinizedCreditCardAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN (''D'', ''C''))))',Updated=TO_DATE('2016-11-30 19:48:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000161
;

-- 30/11/2016 19:54:14 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@TenderType@=''N''',Updated=TO_DATE('2016-11-30 19:54:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001865
;

-- 30/11/2016 19:54:56 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@TenderType@=''A''',Updated=TO_DATE('2016-11-30 19:54:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001865
;

-- 30/11/2016 19:56:51 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@TenderType@=''C''',Updated=TO_DATE('2016-11-30 19:56:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001188
;

-- 30/11/2016 19:57:59 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@TenderType@=''C''',Updated=TO_DATE('2016-11-30 19:57:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001205
;

-- 30/11/2016 19:58:46 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@TenderType@=''D''',Updated=TO_DATE('2016-11-30 19:58:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001772
;

-- 30/11/2016 20:00:35 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic=NULL,Updated=TO_DATE('2016-11-30 20:00:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001188
;

-- 30/11/2016 20:25:26 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@Retiro@=Y',Updated=TO_DATE('2016-11-30 20:25:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001819
;

-- 30/11/2016 20:29:21 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@Deposito@=''Y''',Updated=TO_DATE('2016-11-30 20:29:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001869
;

-- 30/11/2016 20:30:01 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@Transferencia@=''Y''',Updated=TO_DATE('2016-11-30 20:30:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001818
;

-- 01/12/2016 16:30:50 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_DATE('2016-12-01 16:30:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000254
;

-- 01/12/2016 16:33:21 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_DATE('2016-12-01 16:33:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3880
;

-- 01/12/2016 18:15:34 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic=NULL,Updated=TO_DATE('2016-12-01 18:15:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001205
;

-- 01/12/2016 18:15:50 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET MandatoryLogic='@TenderType@=''C''',Updated=TO_DATE('2016-12-01 18:15:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001188
;

-- 01/12/2016 18:24:36 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET ColumnSQL='((SELECT (C_BankStatement.ScrutinizedCashAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType = ''X'')) + (SELECT (C_BankStatement.ScrutinizedCheckAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN (''Z'', ''K''))) + (SELECT (C_BankStatement.ScrutinizedCreditCardAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN (''D'', ''C''))) - C_BankStatement.SaldoInicial)',Updated=TO_DATE('2016-12-01 18:24:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000161
;
