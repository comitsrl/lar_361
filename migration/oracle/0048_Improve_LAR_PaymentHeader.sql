...
-- Incorporar flujo de trabajo para las cabeceras de pagos/cobros
UPDATE AD_Column SET DefaultValue='CO', AD_Reference_Value_ID=135, IsMandatory='Y', AD_Reference_ID=28, AD_Process_ID=3000036,Updated=TO_DATE('2012-09-11 20:13:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000827
;

-- 11/09/2012 20:19:25 ART
-- Incorporar flujo de trabajo para las cabeceras de pagos/cobros
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,Help,EntityType,Description,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3000899,2,'Y','N','N',3000827,'N','Y',3000015,'N','You find the current status in the Document Status field. The options are listed in a popup','LAR','The targeted status of the document','Document Action',100,0,TO_DATE('2012-09-11 20:19:24','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_DATE('2012-09-11 20:19:24','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Incorporar flujo de trabajo para las cabeceras de pagos/cobros
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2012-09-11 20:27:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000901
;

-- 11/09/2012 21:05:12 ART
-- Incorporar flujo de trabajo para las cabeceras de pagos/cobros
UPDATE AD_Workflow SET IsValid='Y', AD_WF_Node_ID=3000001,Updated=TO_DATE('2012-09-11 21:05:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Workflow_ID=3000000
;
