...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_DATE('2020-04-22 18:37:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=5496
;

-- 28/04/2020 20:42:06 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column SET IsAllowCopy='N',Updated=TO_DATE('2020-04-28 20:42:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=5401
;

-- 29/04/2020 20:37:36 ART
-- ISSUE #80: Optimización Cierres de Caja.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001068,'cobroefectivo_id','LAR','cobroefectivo_id','cobroefectivo_id',0,TO_DATE('2020-04-29 20:37:35','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2020-04-29 20:37:35','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ISSUE #80: Optimización Cierres de Caja.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,IsMandatory,Version,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003615,392,'LAR','N',0,'N','N','N',10,'N',19,'N',3001068,'N','Y','N','cobroefectivo_id','cobroefectivo_id',TO_DATE('2020-04-29 20:37:35','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_DATE('2020-04-29 20:37:35','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Optimización Cierres de Caja.
UPDATE AD_Column SET AD_Reference_Value_ID=343, AD_Reference_ID=18, Name='Mov. de Transferencia en Efectivo', ColumnName='CobroEfectivo_ID',Updated=TO_DATE('2020-04-29 20:38:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003615
;
...
-- ISSUE #80: Optimización Cierres de Caja.
UPDATE AD_Column_Trl SET Name='Mov. de Transferencia en Efectivo',Updated=TO_DATE('2020-04-29 20:38:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003615 AND AD_Language='es_AR'
;

-- 29/04/2020 20:39:21 ART
-- ISSUE #80: Optimización Cierres de Caja.
UPDATE AD_Element SET ColumnName='CobroEfectivo_ID', Name='Mov. de Transferencia en Efectivo', PrintName='Mov. de Transferencia en Efectivo',Updated=TO_DATE('2020-04-29 20:39:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001068
;
...
-- 29/04/2020 20:39:21 ART
-- ISSUE #80: Optimización Cierres de Caja.
UPDATE AD_PrintFormatItem pi SET PrintName='Mov. de Transferencia en Efectivo', Name='Mov. de Transferencia en Efectivo' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001068)
;

-- 29/04/2020 20:39:28 ART
-- ISSUE #80: Optimización Cierres de Caja.
UPDATE AD_Element_Trl SET Name='Mov. de Transferencia en Efectivo',PrintName='Mov. de Transferencia en Efectivo',Updated=TO_DATE('2020-04-29 20:39:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001068 AND AD_Language='es_AR'
;

-- 29/04/2020 20:40:31 ART
-- ISSUE #80: Optimización Cierres de Caja.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3006875,10,'Y','N','N',3003615,'N','Y',3000007,'N','LAR','Mov. de Transferencia en Efectivo',100,0,'Y',TO_DATE('2020-04-29 20:40:31','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2020-04-29 20:40:31','YYYY-MM-DD HH24:MI:SS'))
;
