...
-- Add Credit Limit Check Behavior
UPDATE AD_Element SET ColumnName='IsAllowCreditExceeded', Name='IsAllowCreditExceeded', PrintName='IsAllowCreditExceeded',Updated=TO_DATE('2012-03-26 11:05:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000032
;
...
-- Mar 26, 2012 11:05:23 AM ART
-- Add Credit Limit Check Behavior
UPDATE AD_PrintFormatItem pi SET PrintName='IsAllowCreditExceeded', Name='IsAllowCreditExceeded' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3000032)
;

-- Mar 26, 2012 11:07:12 AM ART
-- Add Credit Limit Check Behavior
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3000086,1,'Y','N','N',3000139,'N','Y',676,'N','LAR','IsAllowCreditExceeded',100,0,'Y',TO_DATE('2012-03-26 11:07:12','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2012-03-26 11:07:12','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Add Credit Limit Check Behavior
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2012-03-26 11:08:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000086
;

-- Mar 26, 2012 11:08:17 AM ART
-- Add Credit Limit Check Behavior
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2012-03-26 11:08:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000085
;
