...
(
    LAR_PaymentHeader_ID    number(10,0) NOT NULL,
    ...
    detail                  char(1) DEFAULT 'Y' NULL,
    isreceipt               char(1) DEFAULT 'Y' NULL,
    processed               char(1) DEFAULT 'N' NULL,
...
ADD LAR_PaymentHeader_ID number(10,0),
ADD LAR_PaymentSource_ID number (10,0),
ADD Allocation 			Char(1) DEFAULT 'Y' NULL,
ADD isondrawer 			Char(1) DEFAULT 'Y' NULL;
