...
SELECT C_Payment_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
    ...
    EsRetencionIIBB -- issue #17
FROM C_Payment
;
COMMENT ON TABLE "ADEMPIERE"."C_PAYMENT_V" IS 'Payment Information corrected for AP/AR'
;
