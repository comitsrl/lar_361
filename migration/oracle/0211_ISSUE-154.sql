...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001245,'esperdida','LAR','esperdida','esperdida',0,TO_DATE('2022-05-10 20:01:21','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2022-05-10 20:01:21','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- PRT 2: Configuración Productos.
UPDATE AD_Element SET ColumnName='EsPerdida', Name='Es Perdida', PrintName='Es Perdida',Updated=TO_DATE('2022-05-10 20:01:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001245
;
...
-- 10/05/2022 20:01:55 ART
-- PRT 2: Configuración Productos.
UPDATE AD_PrintFormatItem pi SET PrintName='Es Perdida', Name='Es Perdida' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001245)
;

-- 10/05/2022 20:02:00 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Element_Trl SET Name='Es Perdida',PrintName='Es Perdida',Updated=TO_DATE('2022-05-10 20:02:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001245 AND AD_Language='es_AR'
;

-- 10/05/2022 20:02:13 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Column_Trl SET Name='Es Perdida',Updated=TO_DATE('2022-05-10 20:02:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004459 AND AD_Language='es_AR'
;

-- 10/05/2022 20:04:35 ART
-- PRT 2: Configuración Productos.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007778,1,'Y','N','N',3004459,'N','Y',53345,'N','LAR','Es Perdida',100,0,'Y',TO_DATE('2022-05-10 20:04:35','YYYY-MM-DD HH24:MI:SS'),0,TO_DATE('2022-05-10 20:04:35','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- PRT 2: Configuración Productos.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2022-05-10 20:06:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007778
;

-- 10/05/2022 20:09:38 ART
-- PRT 2: Configuración Productos.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001246,'prioridad','LAR','prioridad','prioridad',0,TO_DATE('2022-05-10 20:09:38','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2022-05-10 20:09:38','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- PRT 2: Configuración Productos.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3004460,259,'LAR',0,'N','N','N','N',10,'N',11,'N',3001246,'N','Y','N','prioridad','prioridad',TO_DATE('2022-05-10 20:09:38','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_DATE('2022-05-10 20:09:38','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- PRT 2: Configuración Productos.
UPDATE AD_Column SET Name='Prioridad', ColumnName='Prioridad',Updated=TO_DATE('2022-05-10 20:10:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004460
;
...
-- PRT 2: Configuración Productos.
UPDATE AD_Element SET ColumnName='Prioridad', Name='Prioridad', PrintName='Prioridad',Updated=TO_DATE('2022-05-10 20:10:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001246
;
...
-- 10/05/2022 20:10:37 ART
-- PRT 2: Configuración Productos.
UPDATE AD_PrintFormatItem pi SET PrintName='Prioridad', Name='Prioridad' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001246)
;

-- 10/05/2022 20:10:41 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Element_Trl SET Name='Prioridad',PrintName='Prioridad',Updated=TO_DATE('2022-05-10 20:10:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001246 AND AD_Language='es_AR'
;

-- 10/05/2022 20:11:32 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Column_Trl SET Name='Prioridad',Updated=TO_DATE('2022-05-10 20:11:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004460 AND AD_Language='es_AR'
;

-- 10/05/2022 20:11:58 ART
-- PRT 2: Configuración Productos.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007779,10,'Y','N','N',3004460,'N','Y',186,'N','LAR','Prioridad',100,0,'Y',TO_DATE('2022-05-10 20:11:58','YYYY-MM-DD HH24:MI:SS'),0,TO_DATE('2022-05-10 20:11:58','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- PRT 2: Configuración Productos.
UPDATE AD_Column SET DefaultValue='@SQL=SELECT COALESCE(MAX(Prioridad),0)+10 AS DefaultValue FROM C_Order @',Updated=TO_DATE('2022-05-10 20:16:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004460
;

-- 10/05/2022 20:17:18 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Column SET DefaultValue='@SQL=SELECT COALESCE(MAX(Prioridad),0)+10 AS DefaultValue FROM C_Order@',Updated=TO_DATE('2022-05-10 20:17:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004460
;
...
-- PRT 2: Configuración Productos.
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_DATE('2022-05-10 20:19:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2876
;

-- 10/05/2022 20:20:01 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Field_Trl SET Name='Fecha de Producción',Description='Fecha Prometida de Producción',Help=NULL,Updated=TO_DATE('2022-05-10 20:20:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2876 AND AD_Language='es_AR'
;
...
-- PRT 2: Configuración Productos.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2022-05-10 20:25:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2876
;

-- 10/05/2022 20:25:50 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2022-05-10 20:25:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007779
;

-- 10/05/2022 20:29:58 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Column SET DefaultValue='@SQL=SELECT COALESCE(MAX(Prioridad),0)+10 AS DefaultValue FROM C_Order WHERE AD_Client_ID = @AD_Client_ID@',Updated=TO_DATE('2022-05-10 20:29:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004460
;

-- 10/05/2022 20:31:08 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Column SET DefaultValue='@#Date@',Updated=TO_DATE('2022-05-10 20:31:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3719
;
...
SELECT register_migration_script_lar('0211_ISSUE-154.sql', 'LAR', '') FROM dual
;
