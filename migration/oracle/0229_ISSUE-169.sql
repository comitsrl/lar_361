-- Add columns to LCO_WithholdingRuleConf
ALTER TABLE LCO_WithholdingRuleConf 
ADD (IsUseDocumentType CHAR(1) DEFAULT 'N' NOT NULL, 
     IsUseShipmentRegion CHAR(1) DEFAULT 'N' NOT NULL);

-- Add CHECK constraints
ALTER TABLE LCO_WithholdingRuleConf 
ADD CONSTRAINT IsUseDocumentType_chk 
CHECK (IsUseDocumentType IN ('Y', 'N'));

ALTER TABLE LCO_WithholdingRuleConf 
ADD CONSTRAINT IsUseShipmentRegion_chk 
CHECK (IsUseShipmentRegion IN ('Y', 'N'));

-- Add column C_Region_ID to LCO_WithholdingRule
ALTER TABLE LCO_WithholdingRule 
ADD C_Region_ID NUMBER(10,0);

-- Add foreign key constraint for C_Region_ID
ALTER TABLE LCO_WithholdingRule 
ADD CONSTRAINT FK_LCO_WithholdingRule_C_Region 
FOREIGN KEY (C_Region_ID) 
REFERENCES C_Region (C_Region_ID);

-- Add column C_DocTypeInvoice_ID to LCO_WithholdingRule
ALTER TABLE LCO_WithholdingRule 
ADD C_DocTypeInvoice_ID NUMBER(10,0);

-- Add foreign key constraint for C_DocTypeInvoice_ID
ALTER TABLE LCO_WithholdingRule 
...
-- 28/03/2025 18:00:51 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001505,'isuseshipmentregion','LAR','isuseshipmentregion','isuseshipmentregion',0,TO_DATE('2025-03-28 18:00:51','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2025-03-28 18:00:51','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Element SET ColumnName='IsUseShipmentRegion', Name='IsUseShipmentRegion', PrintName='IsUseShipmentRegion',Updated=TO_DATE('2025-03-28 18:01:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001505
;
...
-- 28/03/2025 18:01:38 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_PrintFormatItem pi SET PrintName='IsUseShipmentRegion', Name='IsUseShipmentRegion' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001505)
;

-- 28/03/2025 18:01:58 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Usa Provincia Remito',PrintName='Usa Provincia Remito',Updated=TO_DATE('2025-03-28 18:01:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001505 AND AD_Language='es_AR'
;

-- 28/03/2025 18:03:34 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Element SET ColumnName='IsUseDocumentType', Name='IsUseDocumentType', PrintName='IsUseDocumentType',Updated=TO_DATE('2025-03-28 18:03:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001504
;
...
-- 28/03/2025 18:03:34 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_PrintFormatItem pi SET PrintName='IsUseDocumentType', Name='IsUseDocumentType' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001504)
;

-- 28/03/2025 18:03:47 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Usa Tipo de Documento',PrintName='Usa Tipo de Documento',Updated=TO_DATE('2025-03-28 18:03:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001504 AND AD_Language='es_AR'
;

-- 28/03/2025 18:04:23 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,Help,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Description,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3005809,1000006,'LAR',0,'N','N','N','The Region identifies a unique Region for this Country.','N',10,'N',19,'N',209,'N','Y','N','Identifies a geographical Region','Region','C_Region_ID',100,TO_DATE('2025-03-28 18:04:23','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2025-03-28 18:04:23','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009393,1,'Y','N','N',3005808,'N','Y',1000009,'N','LAR','IsUseShipmentRegion',100,0,TO_DATE('2025-03-28 18:07:04','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2025-03-28 18:07:04','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Field SET DisplayLogic='@IsCalcFromPayment@=N',Updated=TO_DATE('2025-03-28 19:23:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3009393
;

-- 28/03/2025 19:23:35 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Field SET DisplayLogic='@IsCalcFromPayment@=N',Updated=TO_DATE('2025-03-28 19:23:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3009392
;

-- 28/03/2025 19:25:03 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Field SET DisplayLogic='@IsCalcFromPayment@=Y',Updated=TO_DATE('2025-03-28 19:25:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3009394
;

-- 28/03/2025 19:25:54 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Field SET DisplayLogic='@IsUseDocumentType@=Y',Updated=TO_DATE('2025-03-28 19:25:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3009394
;

-- 28/03/2025 19:26:56 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Field SET DisplayLogic='@IsUseShipmentRegion@=Y',Updated=TO_DATE('2025-03-28 19:26:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3009395
;

-- 28/03/2025 19:27:32 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Field SET DisplayLogic='@IsCalcFromPayment@=Y',Updated=TO_DATE('2025-03-28 19:27:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3009392
;

-- 28/03/2025 19:28:39 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Column SET AD_Val_Rule_ID=153,Updated=TO_DATE('2025-03-28 19:28:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005809
;

-- 28/03/2025 19:30:19 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Column SET AD_Val_Rule_ID=173,Updated=TO_DATE('2025-03-28 19:30:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005810
;

-- 28/03/2025 19:36:44 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
INSERT INTO AD_Val_Rule (Code,Type,AD_Val_Rule_ID,EntityType,Name,Description,CreatedBy,UpdatedBy,Updated,AD_Client_ID,IsActive,AD_Org_ID,Created) VALUES ('EXISTS (SELECT 1 FROM C_DocType WHERE C_DocType.C_DocType_ID IN  (SELECT C_DocType_ID FROM C_DocType WHERE DocBaseType IN (''ARI'', ''ARC'')))','S',3000152,'LAR','Ret Ventas C_DocTypeInvoice Invoices and Credit Memos','Facturas y NC Ventas para Retenciones',100,100,TO_DATE('2025-03-28 19:36:43','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,TO_DATE('2025-03-28 19:36:43','YYYY-MM-DD HH24:MI:SS'))
;

-- 28/03/2025 19:36:52 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Column SET AD_Val_Rule_ID=3000152, IsUpdateable='N',Updated=TO_DATE('2025-03-28 19:36:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005810
;

-- 28/03/2025 19:45:03 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
INSERT INTO AD_Reference (AD_Reference_ID,ValidationType,EntityType,IsOrderByValue,Name,AD_Client_ID,AD_Org_ID,CreatedBy,Updated,IsActive,Created,UpdatedBy) VALUES (3000173,'T','LAR','N','LAR_Invoices_NC_For_Withholdiing',0,0,100,TO_DATE('2025-03-28 19:45:03','YYYY-MM-DD HH24:MI:SS'),'Y',TO_DATE('2025-03-28 19:45:03','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
INSERT INTO AD_Ref_Table (IsValueDisplayed,WhereClause,AD_Table_ID,AD_Reference_ID,AD_Key,AD_Display,EntityType,CreatedBy,Created,Updated,AD_Client_ID,UpdatedBy,AD_Org_ID,IsActive) VALUES ('N','C_DocType.IsActive=''Y'' AND C_DocType.DocBaseType IN (''ARI'', ''ARC'')',217,3000173,1501,1509,'LAR',100,TO_DATE('2025-03-28 19:48:14','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2025-03-28 19:48:14','YYYY-MM-DD HH24:MI:SS'),0,100,0,'Y')
;

-- 28/03/2025 19:49:35 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Column SET AD_Reference_Value_ID=3000173, AD_Reference_ID=18, AD_Val_Rule_ID=NULL,Updated=TO_DATE('2025-03-28 19:49:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005810
;

-- 29/03/2025 15:27:14 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Ref_Table SET WhereClause='C_DocType.IsActive=''Y'' AND C_DocType.DocBaseType IN (''ARI'', ''ARC'') AND C_DocType.AD_Client_ID=@#AD_Client_ID@',Updated=TO_DATE('2025-03-29 15:27:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=3000173
;

-- 29/03/2025 15:30:16 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Column SET AD_Reference_ID=30,Updated=TO_DATE('2025-03-29 15:30:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005810
;

-- 29/03/2025 15:33:51 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Column SET AD_Reference_ID=18, IsUpdateable='Y',Updated=TO_DATE('2025-03-29 15:33:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005810
;

-- 29/03/2025 15:35:00 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Reference SET Name='LAR_Invoices_For_Withholdiing',Updated=TO_DATE('2025-03-29 15:35:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=3000173
;
...
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Ref_Table SET WhereClause='C_DocType.IsActive=''Y'' AND C_DocType.DocBaseType IN (''API'')',Updated=TO_DATE('2025-03-29 15:35:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=3000173
;

-- 30/03/2025 10:51:14 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Field_Trl SET Name='(Ret IVA) Usa Cat IVA Org',Updated=TO_DATE('2025-03-30 10:51:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000130 AND AD_Language='es_AR'
;

-- 30/03/2025 10:51:21 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_DATE('2025-03-30 10:51:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=1000130
;

-- 31/03/2025 10:24:10 ART
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009398,1,'Y','N','N',3005811,'N','Y',1000010,'N','LAR','IsUseDocumentType',100,0,TO_DATE('2025-03-31 10:24:10','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2025-03-31 10:24:10','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #169: Régimen de Retenciones: Nuevas configuraciones
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009399,1,'Y','N','N',3005813,'N','Y',1000010,'N','LAR','IsUseShipmentRegion',100,0,TO_DATE('2025-03-31 10:24:10','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2025-03-31 10:24:10','YYYY-MM-DD HH24:MI:SS'),100)
;
...
SELECT register_migration_script_lar('0229_ISSUE-169.sql', 'LAR', '') FROM dual
;
