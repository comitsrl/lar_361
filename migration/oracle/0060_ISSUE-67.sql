...
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Field_Trl SET IsTranslated='Y',Name='Total Facturas',Updated=TO_DATE('2015-02-03 12:36:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001296 AND AD_Language='es_AR'
;

-- 03/02/2015 12:37:45 ART
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Tab_Trl SET IsTranslated='Y',Name='Facturas a las cuales se asignarán los cobros.',Updated=TO_DATE('2015-02-03 12:37:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000045 AND AD_Language='es_AR'
;

-- 03/02/2015 12:39:13 ART
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Field_Trl SET Description='Suma del importe a asignar de las facturas bajo el Recibo.',Updated=TO_DATE('2015-02-03 12:39:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001296 AND AD_Language='es_AR'
;

-- 03/02/2015 12:41:12 ART
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Tab_Trl SET Description='Facturas a las cuales se asignarán los cobros.',Updated=TO_DATE('2015-02-03 12:41:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000045 AND AD_Language='es_AR'
;

-- 03/02/2015 12:41:20 ART
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Tab_Trl SET Name='Facturas',Updated=TO_DATE('2015-02-03 12:41:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000045 AND AD_Language='es_AR'
;

-- 03/02/2015 12:45:03 ART
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Field_Trl SET IsTranslated='Y',Name='Es Retención Sufrida',Description='Indica si en el registro se cargará una retención.',Updated=TO_DATE('2015-02-03 12:45:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001624 AND AD_Language='es_AR'
;
...
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Field SET IsReadOnly='Y', DisplayLogic=NULL,Updated=TO_DATE('2015-02-07 09:30:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000602
;

-- 07/02/2015 9:31:41 ART
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Column SET ColumnSQL=NULL,Updated=TO_DATE('2015-02-07 09:31:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000264
;

-- 07/02/2015 9:33:08 ART
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Column SET ColumnSQL='(SELECT COALESCE(Sum(Amount),0) FROM C_PaymentAllocate i WHERE  LAR_PaymentHeader.LAR_PaymentHeader_ID = i.LAR_PaymentHeader_ID) -((SELECT COALESCE(Sum(PayAmt),0) FROM C_Payment p WHERE  LAR_PaymentHeader.LAR_PaymentHeader_ID = p.LAR_PaymentHeader_ID) + (SELECT COALESCE(Sum(WriteOffAmt),0) FROM C_Payment p WHERE  LAR_PaymentHeader.LAR_PaymentHeader_ID = p.LAR_PaymentHeader_ID))', IsUpdateable='N',Updated=TO_DATE('2015-02-07 09:33:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000264
;
...
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_DATE('2015-02-09 08:26:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001296
;

-- 09/02/2015 8:28:00 ART
-- ISSUE#67 Agrega Tab Facturas a Ventana Recibo (Varios Cobros)
UPDATE AD_Field_Trl SET IsTranslated='Y',Name='Total Facturas',Description='Suma el total a pagar de las facturas bajo la cabecera',Help='Suma del importe impago de las facturas cargadas bajo la cabecera.',Updated=TO_DATE('2015-02-09 08:28:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001296 AND AD_Language='es_AR'
;
