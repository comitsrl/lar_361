...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001243,'eswebsocket','LAR','eswebsocket','eswebsocket',0,TO_DATE('2022-04-20 18:47:18','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2022-04-20 18:47:18','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ISSUE #157: Impresoras Fiscales de Segunda Generación.
UPDATE AD_Column SET Name='Web Socket', ColumnName='EsWebSocket',Updated=TO_DATE('2022-04-20 18:47:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004456
;
...
-- ISSUE #157: Impresoras Fiscales de Segunda Generación.
UPDATE AD_Column_Trl SET Name='Web Socket',Updated=TO_DATE('2022-04-20 18:47:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004456 AND AD_Language='es_AR'
;

-- 20/04/2022 18:48:17 ART
-- ISSUE #157: Impresoras Fiscales de Segunda Generación.
UPDATE AD_Element SET ColumnName='EsWebSocket', Name='Web Socket', PrintName='Web Socket',Updated=TO_DATE('2022-04-20 18:48:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001243
;
...
-- ISSUE #157: Impresoras Fiscales de Segunda Generación.
UPDATE AD_PrintFormatItem pi SET PrintName='Web Socket', Name='Web Socket' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001243)
;

-- 20/04/2022 18:48:24 ART
-- ISSUE #157: Impresoras Fiscales de Segunda Generación.
UPDATE AD_Element_Trl SET Name='Web Socket',PrintName='Web Socket',Updated=TO_DATE('2022-04-20 18:48:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001243 AND AD_Language='es_AR'
;

-- 20/04/2022 18:49:47 ART
-- ISSUE #157: Impresoras Fiscales de Segunda Generación.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,AD_Tab_ID,IsCentrallyMaintained,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3007772,1,'Y','N','N',3004456,'N',3000001,'Y','N','LAR','Web Socket',100,0,'Y',TO_DATE('2022-04-20 18:49:47','YYYY-MM-DD HH24:MI:SS'),0,100,TO_DATE('2022-04-20 18:49:47','YYYY-MM-DD HH24:MI:SS'))
;
...
SELECT register_migration_script_lar('0209_ISSUE-157.sql', 'LAR', '') FROM dual
;
