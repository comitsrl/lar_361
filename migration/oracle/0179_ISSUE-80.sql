...
UPDATE AD_Ref_Table SET WhereClause='LAR_Tarjeta_Credito.EsQR = ''Y''', OrderByClause='LAR_Tarjeta_Credito.Name',Updated=TO_DATE('2021-06-14 18:39:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=3000124
;

-- 14/06/2021 19:07:18 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,IsMandatory,Version,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003932,3000032,'LAR','N',0,'N','N','N',10,'N',19,'N',3001141,'N','Y','N','Billetera Digital','LAR_Quick_Response_ID',TO_DATE('2021-06-14 19:07:18','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_DATE('2021-06-14 19:07:18','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Field SET DisplayLogic='@TenderType@=''Q''',Updated=TO_DATE('2021-06-14 19:08:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007075
;

-- Registración de script
SELECT register_migration_script_lar('0179_ISSUE-80.sql', 'LAR', '') FROM dual
;
