-- Se agrega columna IsOnDrawer en vista C_Payment_V
...
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,Help,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Description,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003016,3000082,'LAR',0,'N','N','N','The Payment is a unique identifier of this payment.','N',10,'N',19,'N',1384,'N','Y','N','Payment identifier','Payment','C_Payment_ID',100,TO_DATE('2018-10-02 16:18:09','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2018-10-02 16:18:09','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Cierre de Cajas.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,Help,EntityType,Description,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3005761,10,'Y','N','N',3003016,'N','Y',3000128,'N','The Payment is a unique identifier of this payment.','LAR','Payment identifier','Payment',100,0,TO_DATE('2018-10-02 16:19:23','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2018-10-02 16:19:23','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Field SET DisplayLogic='@TenderType@=''Z''',Updated=TO_DATE('2018-10-02 16:20:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005761
;

-- 02/10/2018 16:31:28 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Field_Trl SET IsTranslated='Y',Name='Cheque',Description='Cheque Original',Help=NULL,Updated=TO_DATE('2018-10-02 16:31:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005761 AND AD_Language='es_AR'
;

-- 02/10/2018 16:31:42 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Field SET IsCentrallyMaintained='N', IsReadOnly='Y',Updated=TO_DATE('2018-10-02 16:31:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005761
;

-- Registración de script
SELECT register_migration_script_lar('0116_ISSUE-80.sql', 'LAR', '') FROM dual
;
