...
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3005815,1000001,'LAR',0,'N','N','N','N',2,'N',22,'N',3000270,'N','Y','N','WSFECode','WSFECode',100,TO_DATE('2025-04-10 22:10:08','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2025-04-10 22:10:08','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #77: Informar Cond. IVA del Cliente en FE
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3009401,2,'Y','N','N',3005815,'N','Y',1000006,'N','LAR','WSFECode',100,0,TO_DATE('2025-04-10 22:10:37','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_DATE('2025-04-10 22:10:37','YYYY-MM-DD HH24:MI:SS'),100)
;
...
SELECT register_migration_script_lar('0231_ISSUE-77.sql', 'LAR', '') FROM dual
;
