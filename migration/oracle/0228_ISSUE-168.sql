...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001501,'crearop','LAR','crearop','crearop',0,TO_DATE('2025-02-28 00:24:19','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2025-02-28 00:24:19','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- 28/02/2025 0:24:20 ART
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,AD_Org_ID,CreatedBy,AD_Client_ID,IsActive,Created,UpdatedBy) VALUES (3005801,318,'LAR',0,'N','N','N','N',1,'N',20,'N',3001501,'N','Y','N','crearop','crearop',TO_DATE('2025-02-28 00:24:19','YYYY-MM-DD HH24:MI:SS'),0,100,0,'Y',TO_DATE('2025-02-28 00:24:19','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Element SET ColumnName='CrearOP', Name='Crear Orden de Pago', PrintName='Crear Orden de Pago',Updated=TO_DATE('2025-02-28 00:25:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001501
;
...
-- 28/02/2025 0:25:16 ART
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_PrintFormatItem pi SET PrintName='Crear Orden de Pago', Name='Crear Orden de Pago' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=3001501)
;

-- 28/02/2025 0:25:49 ART
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Element_Trl SET Name='Crear Orden de Pago',PrintName='Crear Orden de Pago',Updated=TO_DATE('2025-02-28 00:25:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001501 AND AD_Language='es_AR'
;

-- 28/02/2025 0:26:43 ART
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Column SET AD_Reference_ID=28, Name='Crear Orden de Pago', ColumnName='CrearOP',Updated=TO_DATE('2025-02-28 00:26:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005801
;

-- 28/02/2025 0:26:59 ART
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Column_Trl SET Name='Crear Orden de Pago',Updated=TO_DATE('2025-02-28 00:26:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005801 AND AD_Language='es_AR'
;
...
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Field SET DisplayLogic='1=2',Updated=TO_DATE('2025-02-28 00:56:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3009383
;

-- 28/02/2025 1:17:20 ART
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Column SET IsAlwaysUpdateable='Y',Updated=TO_DATE('2025-02-28 01:17:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005801
;

-- Registración de script
SELECT register_migration_script_lar('0228_ISSUE-168.sql', 'LAR', '') FROM dual
;
