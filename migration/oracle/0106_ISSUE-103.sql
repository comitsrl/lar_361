...
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,Help,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Description,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3002825,660,'LAR',0,'Y','N','N','The List Price is the official List Price in the document currency.','N',10,'N',11,'N',520,'N','Y','N','List Price','List Price','PriceList',TO_DATE('2018-04-11 18:13:32','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_DATE('2018-04-11 18:13:32','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #103: Se agrega columna Precio de Lista en M_RmaLine
UPDATE AD_Field SET IsSameLine='Y', IsReadOnly='Y', DisplayLogic='@Processed@=''Y''',Updated=TO_DATE('2018-04-11 18:20:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005397
;
...
-- ISSUE #103: Se agrega columna Precio de Lista en M_RmaLine
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_DATE('2018-04-11 18:22:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005396
;

-- 11/04/2018 18:22:09 ART
-- ISSUE #103: Se agrega columna Precio de Lista en M_RmaLine
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2018-04-11 18:22:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=52001
;

-- 11/04/2018 18:22:17 ART
-- ISSUE #103: Se agrega columna Precio de Lista en M_RmaLine
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2018-04-11 18:22:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005396
;

-- 11/04/2018 19:09:58 ART
-- ISSUE #103: Se agrega columna Precio de Lista en M_RmaLine
UPDATE AD_Column SET AD_Reference_ID=37,Updated=TO_DATE('2018-04-11 19:09:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002825
;

-- Registración de script
SELECT register_migration_script_lar('0106_ISSUE-103.sql', 'LAR', '') FROM dual
;
