...
UPDATE AD_Val_Rule SET Code='LAR_Tarjeta_Credito.EsDebito=''N'' AND LAR_Tarjeta_Credito.EsDeposito=''N'' AND LAR_Tarjeta_Credito.EsChequeEmitido=''N''',Updated=TO_DATE('2017-08-29 16:26:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=3000031
;
