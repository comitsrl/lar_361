...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3000419,'fecha_venc_cheque','LAR','fecha_venc_cheque','fecha_venc_cheque',0,TO_TIMESTAMP('2016-12-29 17:42:01','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2016-12-29 17:42:01','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ISSUE #80: Cierre de cajas.
UPDATE AD_Column SET Name='Fecha de Venc. Cheque', ColumnName='Fecha_Venc_Cheque',Updated=TO_TIMESTAMP('2016-12-29 17:42:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001958
;
...
-- ISSUE #80: Cierre de cajas.
UPDATE AD_Column_Trl SET Name='Fecha de Venc. Cheque',Updated=TO_TIMESTAMP('2016-12-29 17:42:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001958 AND AD_Language='es_AR'
;

-- 29/12/2016 17:43:24 ART
-- ISSUE #80: Cierre de cajas.
UPDATE AD_Element SET ColumnName='Fecha_Venc_Cheque', Name='Fecha de Venc. Cheque', PrintName='Fecha de Venc. Cheque',Updated=TO_TIMESTAMP('2016-12-29 17:43:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000419
;
...
-- 29/12/2016 17:43:24 ART
-- ISSUE #80: Cierre de cajas.
UPDATE AD_PrintFormatItem SET PrintName='Fecha de Venc. Cheque', Name='Fecha de Venc. Cheque' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3000419)
;

-- 29/12/2016 17:43:39 ART
-- ISSUE #80: Cierre de cajas.
UPDATE AD_Element_Trl SET Name='Fecha de Venc. Cheque',PrintName='Fecha de Venc. Cheque',Updated=TO_TIMESTAMP('2016-12-29 17:43:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000419 AND AD_Language='es_AR'
;

-- 29/12/2016 17:43:55 ART
-- ISSUE #80: Cierre de cajas.
UPDATE AD_Column SET AD_Reference_ID=15,Updated=TO_TIMESTAMP('2016-12-29 17:43:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001958
;

-- 29/12/2016 17:45:53 ART
-- ISSUE #80: Cierre de cajas.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3003009,29,'Y','N','N',3001958,'N','Y',3000013,'N','LAR','Fecha de Venc. Cheque',100,0,'Y',TO_TIMESTAMP('2016-12-29 17:45:47','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2016-12-29 17:45:47','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #80: Cierre de cajas.
UPDATE AD_Field SET DisplayLogic='@TenderType@=K | @TenderType@=Z',Updated=TO_TIMESTAMP('2016-12-29 17:57:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3003009
;

-- 29/12/2016 17:59:56 ART
-- ISSUE #80: Cierre de cajas.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2016-12-29 17:59:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3003009
;

-- 29/12/2016 18:04:09 ART
-- ISSUE #80: Cierre de cajas.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3003010,29,'Y','N','N',3001958,'N','Y',3000024,'N','LAR','Fecha de Venc. Cheque',100,0,'Y',TO_TIMESTAMP('2016-12-29 18:04:09','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2016-12-29 18:04:09','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #80: Cierre de cajas.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2016-12-29 18:05:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3003010
;
