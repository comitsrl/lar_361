...
INSERT INTO AD_Val_Rule (Code,Type,AD_Val_Rule_ID,EntityType,Name,CreatedBy,UpdatedBy,Updated,AD_Client_ID,IsActive,AD_Org_ID,Created) VALUES ('(IsSOTrx=''@IsSOTrx@'' AND DocStatus=''CO'' AND IsDelivered=''N'')','S',3000090,'LAR','LAR_C_Order in M_InOut (Completa, de Venta y No entregada)',100,100,TO_TIMESTAMP('2021-05-18 21:37:51','YYYY-MM-DD HH24:MI:SS'),0,'Y',0,TO_TIMESTAMP('2021-05-18 21:37:51','YYYY-MM-DD HH24:MI:SS'))
;
