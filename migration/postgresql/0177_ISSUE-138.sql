...
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET SeqNo=50,Updated=TO_TIMESTAMP('2021-06-09 20:03:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007054
;

-- 09/06/2021 20:04:01 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET IsDisplayed='N',Updated=TO_TIMESTAMP('2021-06-09 20:04:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2779
;

-- 09/06/2021 20:07:56 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Column SET IsIdentifier='N', IsSelectionColumn='N',Updated=TO_TIMESTAMP('2021-06-09 20:07:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003927
;

-- 10/06/2021 18:21:42 ART
-- Agrega_maxlines_en_C_DocType.sql
UPDATE AD_Field SET DisplayLength=20,Updated=TO_TIMESTAMP('2021-06-10 18:21:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007054
;
...
-- Agrega_maxlines_en_C_DocType.sql
UPDATE AD_Field SET SortNo=1.000000000000,Updated=TO_TIMESTAMP('2021-06-10 18:33:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2779
;

-- 10/06/2021 18:42:02 ART
-- Agrega_maxlines_en_C_DocType.sql
UPDATE AD_Field SET SortNo=-1.000000000000, SeqNo=50,Updated=TO_TIMESTAMP('2021-06-10 18:42:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2779
;

-- 10/06/2021 18:44:42 ART
-- Agrega_maxlines_en_C_DocType.sql
UPDATE AD_Field SET DisplayLogic='@IsSOTrx@ = ''N''',Updated=TO_TIMESTAMP('2021-06-10 18:44:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2779
;

-- 10/06/2021 18:45:19 ART
-- Agrega_maxlines_en_C_DocType.sql
UPDATE AD_Field SET DisplayLogic='@IsSOTrx@ = ''Y''',Updated=TO_TIMESTAMP('2021-06-10 18:45:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007054
;

-- 10/06/2021 18:47:42 ART
-- Agrega_maxlines_en_C_DocType.sql
UPDATE AD_Field SET IsSameLine='Y', SeqNo=55,Updated=TO_TIMESTAMP('2021-06-10 18:47:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007054
;

-- 10/06/2021 18:49:27 ART
-- Agrega_maxlines_en_C_DocType.sql
UPDATE AD_Field SET SortNo=NULL,Updated=TO_TIMESTAMP('2021-06-10 18:49:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2779
;

-- 10/06/2021 19:17:55 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2021-06-10 19:17:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007054
;

-- Registración de script
SELECT register_migration_script_lar('0177_ISSUE-138.sql', 'LAR', '')
;
