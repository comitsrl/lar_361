...
-- Show Invoice Info on Header and avoid overpayment (Receipts)
UPDATE AD_Field SET DisplayLogic='@RemainingAmt@>0 | @RemainingAmt@=0 | @InvoiceAmt@=0',Updated=TO_TIMESTAMP('2012-07-29 00:19:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000277
;

-- 29/07/2012 0:21:51 ART
-- Show Invoice Info on Header and avoid overpayment (Receipts)
UPDATE AD_Field SET DisplayLogic='@RemainingAmt@>0 | @RemainingAmt@=0 | @InvoiceAmt@=0',Updated=TO_TIMESTAMP('2012-07-29 00:21:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000762
;

-- 29/07/2012 0:24:20 ART
-- Show Invoice Info on Header and avoid overpayment (Receipts)
UPDATE AD_Field SET DisplayLogic='@RemainingAmt@>0 | @RemainingAmt@=0 | @InvoiceAmt@=0',Updated=TO_TIMESTAMP('2012-07-29 00:24:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000399
;
