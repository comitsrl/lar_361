...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001348,'permite_fecha_futura','LAR','permite_fecha_futura','permite_fecha_futura',0,TO_TIMESTAMP('2022-10-18 22:07:49','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2022-10-18 22:07:49','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- ISSUE #159: No permitir comprobantes con fecha futura.
UPDATE AD_Element SET ColumnName='Permite_Fecha_Futura', Name='Permite Fecha Futura', PrintName='Permite Fecha Futura',Updated=TO_TIMESTAMP('2022-10-18 22:09:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001348
;
...
-- 18/10/2022 22:09:27 ART
-- ISSUE #159: No permitir comprobantes con fecha futura.
UPDATE AD_PrintFormatItem SET PrintName='Permite Fecha Futura', Name='Permite Fecha Futura' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001348)
;

-- 18/10/2022 22:09:51 ART
-- ISSUE #159: No permitir comprobantes con fecha futura.
UPDATE AD_Element_Trl SET Name='Permite Fecha Futura',PrintName='Permite Fecha Futura',Updated=TO_TIMESTAMP('2022-10-18 22:09:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001348 AND AD_Language='es_AR'
;

-- 18/10/2022 22:10:20 ART
-- ISSUE #159: No permitir comprobantes con fecha futura.
UPDATE AD_Column_Trl SET Name='Permite Fecha Futura',Updated=TO_TIMESTAMP('2022-10-18 22:10:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005270 AND AD_Language='es_AR'
;

-- 18/10/2022 22:10:40 ART
-- ISSUE #159: No permitir comprobantes con fecha futura.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3008050,1,'Y','N','N',3005270,'N','Y',167,'N','LAR','Permite Fecha Futura',100,0,TO_TIMESTAMP('2022-10-18 22:10:39','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_TIMESTAMP('2022-10-18 22:10:39','YYYY-MM-DD HH24:MI:SS'))
;
...
SELECT register_migration_script_lar('0215_ISSUE-159.sql', 'LAR', '')
;
