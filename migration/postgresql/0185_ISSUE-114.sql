...
-- ISSUE #114: Tipo de Cambio en Lista Madre.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,Help,EntityType,Description,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007254,10,'Y','N','N',3004152,'N','Y',191,'N','The Currency Conversion Rate Type lets you define different type of rates, e.g. Spot, Corporate and/or Sell/Buy rates.','LAR','Currency Conversion Rate Type','Currency Type',100,0,TO_TIMESTAMP('2021-07-21 18:28:21','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2021-07-21 18:28:21','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #114: Tipo de Cambio en Lista Madre.
UPDATE AD_Field SET DisplayLogic='@EsListaMadre@=''Y''',Updated=TO_TIMESTAMP('2021-07-21 18:35:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007254
;
...
SELECT register_migration_script_lar('0185_ISSUE-114.sql', 'LAR', '')
;
