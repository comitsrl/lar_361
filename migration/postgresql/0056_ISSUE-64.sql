...
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
ALTER TABLE C_POS ADD COLUMN C_DocTypeOnCredit_ID NUMERIC(10)
;
...
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
ALTER TABLE M_InOut ADD COLUMN IsFiscalPrinted CHARACTER(1) NOT NULL DEFAULT 'N'
;
...
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3000164,'c_doctypeoncredit_id','LAR','c_doctypeoncredit_id','c_doctypeoncredit_id',0,TO_TIMESTAMP('2014-05-15 09:10:00','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2014-05-15 09:10:00','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- 15/05/2014 9:10:07 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3000882,748,'LAR',0,'N','N','N','N',10,'N',19,'N',3000164,'N','Y','N','c_doctypeoncredit_id','c_doctypeoncredit_id',100,TO_TIMESTAMP('2014-05-15 09:10:00','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2014-05-15 09:10:00','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Element SET ColumnName='C_DocTypeOnCredit_ID', Name='C_DocTypeOnCredit_ID', PrintName='C_DocTypeOnCredit_ID',Updated=TO_TIMESTAMP('2014-05-15 09:18:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000164
;
...
-- 15/05/2014 9:18:08 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_PrintFormatItem SET PrintName='C_DocTypeOnCredit_ID', Name='C_DocTypeOnCredit_ID' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3000164)
;

-- 15/05/2014 9:40:57 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
INSERT INTO AD_Reference (AD_Reference_ID,ValidationType,EntityType,IsOrderByValue,Name,AD_Client_ID,AD_Org_ID,CreatedBy,Updated,IsActive,Created,UpdatedBy) VALUES (3000029,'T','LAR','N','C_DocType LAR PDV',0,0,100,TO_TIMESTAMP('2014-05-15 09:40:50','YYYY-MM-DD HH24:MI:SS'),'Y',TO_TIMESTAMP('2014-05-15 09:40:50','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Column_Trl SET Name='Tipo de Documento CtaCte',Updated=TO_TIMESTAMP('2014-05-15 09:53:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000882 AND AD_Language='es_AR'
;

-- 15/05/2014 9:53:55 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field_Trl SET Name='Tipo de Documento CtaCte',Updated=TO_TIMESTAMP('2014-05-15 09:53:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001590 AND AD_Language='es_AR'
;

-- 15/05/2014 9:54:18 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field_Trl SET Name='Tipo de Documento Contado',Updated=TO_TIMESTAMP('2014-05-15 09:54:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10811 AND AD_Language='es_AR'
;

-- 15/05/2014 10:13:29 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field SET DisplayLogic='@IsShipment@=''N''',Updated=TO_TIMESTAMP('2014-05-15 10:13:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001590
;
...
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field_Trl SET Name='Tipo de Recibo',Updated=TO_TIMESTAMP('2014-05-15 10:19:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000742 AND AD_Language='es_AR'
;

-- 18/05/2014 12:18:59 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3000884,319,'LAR',0,'Y','N','N','N',1,'N',20,'N',3000015,'N','Y','N','IsFiscalPrinted','IsFiscalPrinted',100,TO_TIMESTAMP('2014-05-18 12:18:58','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2014-05-18 12:18:58','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 18/05/2014 12:18:59 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3000885,319,'LAR',0,'N','N','N','N',30,'N',10,'N',3000016,'N','Y','N','FiscalReceiptNumber','FiscalReceiptNumber',100,TO_TIMESTAMP('2014-05-18 12:18:59','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2014-05-18 12:18:59','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- 18/05/2014 12:40:05 ART
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3001593,1,'Y','N','N',3000884,'N','Y',257,'N','LAR','IsFiscalPrinted',100,0,TO_TIMESTAMP('2014-05-18 12:40:05','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_TIMESTAMP('2014-05-18 12:40:05','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2014-05-18 12:44:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001592
;
...
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2014-05-18 12:45:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001593
;

-- 18/05/2014 12:45:37 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2014-05-18 12:45:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001592
;

-- 18/05/2014 12:49:40 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field_Trl SET Name='Número de Remito Fiscal',Updated=TO_TIMESTAMP('2014-05-18 12:49:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001592 AND AD_Language='es_AR'
;

-- 18/05/2014 12:51:04 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
UPDATE AD_Field_Trl SET Name='Impreso Fiscal',Updated=TO_TIMESTAMP('2014-05-18 12:51:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001593 AND AD_Language='es_AR'
;

-- 18/05/2014 22:07:07 ART
-- Leimat #12 - LAR #64: Impresión de Remitos por CF
INSERT INTO AD_WF_Node (AD_WF_Node_ID,Cost,DynPriorityChange,Priority,DocAction,Duration,EntityType,IsCentrallyMaintained,JoinElement,"limit",WaitTime,WorkingTime,XPosition,YPosition,WaitingTime,AD_Process_ID,AD_Workflow_ID,"action",SplitElement,Value,Name,UpdatedBy,Created,AD_Org_ID,CreatedBy,IsActive,Updated,AD_Client_ID) VALUES (3000008,0,0,0,'CO',0,'LAR','Y','X',0,0,0,0,0,0,3000071,116,'P','X','(DocFiscalPrinting)','(LAR_ShipmentFiscalPrinting)',100,TO_TIMESTAMP('2014-05-18 22:07:06','YYYY-MM-DD HH24:MI:SS'),0,100,'Y',TO_TIMESTAMP('2014-05-18 22:07:06','YYYY-MM-DD HH24:MI:SS'),0)
;
