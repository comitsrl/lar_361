...
UPDATE AD_Field_Trl SET Name='Relacionado a un Activo',Updated=TO_TIMESTAMP('2014-02-02 11:35:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=56249 AND AD_Language='es_AR'
;

-- 02/02/2014 11:37:13 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field_Trl SET Name='Diario Nº',Description='Diario Nº',Help='Identifica al grupo de líneas correspondientes al Diario que representa una transacción lógica del negocio.',Updated=TO_TIMESTAMP('2014-02-02 11:37:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=716 AND AD_Language='es_AR'
;

-- 02/02/2014 11:39:02 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field_Trl SET Name='Diario No.',Description='Número de secuencia del Diario.',Help='El número del documento es usualmente generado en automático por el sistema y determinado por el tipo del documento. Si el documento no se graba; el número preliminar se despliega entre "<>"',Updated=TO_TIMESTAMP('2014-02-02 11:39:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=698 AND AD_Language='es_AR'
;

-- 02/02/2014 11:39:08 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_TIMESTAMP('2014-02-02 11:39:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=698
;

-- 02/02/2014 11:39:33 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_TIMESTAMP('2014-02-02 11:39:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=716
;

-- 02/02/2014 11:39:42 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field_Trl SET Name='Diario No.',Description='Diario No.',Updated=TO_TIMESTAMP('2014-02-02 11:39:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=716 AND AD_Language='es_AR'
;

-- 02/02/2014 11:42:03 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2014-02-02 11:42:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=56249
;

-- 02/02/2014 11:53:35 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
INSERT INTO AD_Element (AD_Element_ID,ColumnName,Help,EntityType,Name,Description,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3000155,'VC_Description','A description is limited to 255 characters.','LAR','VC_Description','Valid Combination Description. Optional short description of the record','VC_Description',0,TO_TIMESTAMP('2014-02-02 11:53:34','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2014-02-02 11:53:34','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2014-02-02 12:01:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001408
;

-- 02/02/2014 12:03:03 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_TIMESTAMP('2014-02-02 12:03:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001408
;

-- 02/02/2014 12:03:56 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Field_Trl SET IsTranslated='Y',Name='Descripción',Description='Descripción de la Combinación Contable.',Help='En esta ventana se muestran hasta 60 caracteres de la Descripción.',Updated=TO_TIMESTAMP('2014-02-02 12:03:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3001408 AND AD_Language='es_AR'
;

-- 02/02/2014 12:06:34 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Column SET IsKey='Y', IsUpdateable='N', IsAllowCopy='N',Updated=TO_TIMESTAMP('2014-02-02 12:06:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1794
;

-- 02/02/2014 12:07:03 ART
-- Agregar Campo Descripción (Combinación Contable)  a la Pestaña Línea, Ventana Diario de CG
UPDATE AD_Column SET IsKey='Y', IsUpdateable='N', IsAllowCopy='N',Updated=TO_TIMESTAMP('2014-02-02 12:07:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1654
;

SELECT register_migration_script_lar('0055_Agrega_Campo_VCDescription_Pestaña_Linea_Ventana_DiarioCG.sql','LAR','');
