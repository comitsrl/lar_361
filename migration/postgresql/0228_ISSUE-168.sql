...
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
INSERT INTO AD_Process (AD_Process_ID,IsDirectPrint,IsReport,AccessLevel,IsBetaFunctionality,IsServerProcess,ShowHelp,EntityType,Statistic_Seconds,Statistic_Count,Classname,CopyFromProcess,Value,Name,AD_Org_ID,AD_Client_ID,UpdatedBy,CreatedBy,Updated,Created,IsActive) VALUES (3000594,'N','N','3','N','N','Y','LAR',0,0,'ar.com.ergio.process.LAR_GenerarOrdenPago','N','LAR_GenerarOP','LAR_GenerarOP',0,0,100,100,TO_TIMESTAMP('2025-02-28 00:35:26','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2025-02-28 00:35:26','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
INSERT INTO AD_Process_Para (IsRange,AD_Process_Para_ID,FieldLength,Help,AD_Process_ID,CreatedBy,IsCentrallyMaintained,AD_Reference_ID,AD_Val_Rule_ID,SeqNo,IsMandatory,AD_Element_ID,EntityType,Name,ColumnName,Description,IsActive,AD_Client_ID,UpdatedBy,Updated,Created,AD_Org_ID,IsEncrypted) VALUES ('N',3001045,0,'The Bank Account identifies an account at this Bank.',3000594,100,'Y',19,3000004,10,'N',836,'LAR','Bank Account','C_BankAccount_ID','Account at the Bank','Y',0,100,TO_TIMESTAMP('2025-02-28 00:39:16','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2025-02-28 00:39:16','YYYY-MM-DD HH24:MI:SS'),0,'N')
;
...
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Caja',Description=NULL,Help=NULL,Updated=TO_TIMESTAMP('2025-02-28 00:40:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=3001045 AND AD_Language='es_AR'
;

-- 28/02/2025 0:40:07 ART
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Process_Para SET IsCentrallyMaintained='N',Updated=TO_TIMESTAMP('2025-02-28 00:40:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=3001045
;

-- 28/02/2025 0:42:34 ART
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Process_Para SET Help=NULL, Name='Caja', Description=NULL,Updated=TO_TIMESTAMP('2025-02-28 00:42:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=3001045
;
...
-- ISSUE #168: Generación automatica de OP, desde Factura Proveedor.
UPDATE AD_Column SET AD_Process_ID=3000594,Updated=TO_TIMESTAMP('2025-02-28 00:50:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005801
;
