...
-- Add toggle withholding on sales
INSERT INTO AD_Element (ColumnName,AD_Element_ID,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES ('isgeneratewithholdingonsale',3000036,'LAR','isgeneratewithholdingonsale','isgeneratewithholdingonsale',0,TO_TIMESTAMP('2012-03-26 17:32:38','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2012-03-26 17:32:38','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- Add toggle withholding on sales
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3000144,748,'LAR',0,'Y','N','N','N',1,'N',20,'N',3000036,'N','Y','N','isgeneratewithholdingonsale','isgeneratewithholdingonsale',100,TO_TIMESTAMP('2012-03-26 17:32:38','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2012-03-26 17:32:38','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Add toggle withholding on sales
UPDATE AD_Element SET ColumnName='IsGenerateWithholdingOnSale', Name='IsGenerateWithholdingOnSale', PrintName='IsGenerateWithholdingOnSale',Updated=TO_TIMESTAMP('2012-03-26 17:33:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000036
;
...
-- Mar 26, 2012 5:33:43 PM GMT-03:00
-- Add toggle withholding on sales
UPDATE AD_PrintFormatItem SET PrintName='IsGenerateWithholdingOnSale', Name='IsGenerateWithholdingOnSale' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3000036)
;

-- Mar 26, 2012 5:34:43 PM GMT-03:00
-- Add toggle withholding on sales
INSERT INTO AD_Field (IsEncrypted,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,AD_Field_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',1,'Y','N','N',3000144,'N','Y',676,3000087,'N','LAR','IsGenerateWithholdingOnSale',100,0,'Y',TO_TIMESTAMP('2012-03-26 17:34:42','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2012-03-26 17:34:42','YYYY-MM-DD HH24:MI:SS'))
;
...
-- Add toggle withholding on sales
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2012-03-26 18:23:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000085
;
