...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001181,'fecha_cert_retencion','LAR','fecha_cert_retencion','fecha_cert_retencion',0,TO_TIMESTAMP('2021-08-02 16:41:31','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2021-08-02 16:41:31','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ISSUE #81: Fecha de certificado de retención en recibos.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3004171,335,'LAR',0,'N','N','N','N',29,'N',16,'N',3001181,'N','Y','N','fecha_cert_retencion','fecha_cert_retencion',TO_TIMESTAMP('2021-08-02 16:41:31','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_TIMESTAMP('2021-08-02 16:41:31','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #81: Fecha de certificado de retención en recibos.
UPDATE AD_Column SET Name='Fecha de Certificado de Retención', ColumnName='Fecha_Cert_Retencion',Updated=TO_TIMESTAMP('2021-08-02 16:42:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004171
;
...
-- ISSUE #81: Fecha de certificado de retención en recibos.
UPDATE AD_Column_Trl SET Name='Fecha de Certificado de Retención',Updated=TO_TIMESTAMP('2021-08-02 16:42:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004171 AND AD_Language='es_AR'
;

-- 02/08/2021 16:43:01 ART
-- ISSUE #81: Fecha de certificado de retención en recibos.
UPDATE AD_Element SET ColumnName='Fecha_Cert_Retencion', Name='Fecha de Certificado de Retención', PrintName='Fecha de Certificado de Retención',Updated=TO_TIMESTAMP('2021-08-02 16:43:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001181
;
...
-- 02/08/2021 16:43:01 ART
-- ISSUE #81: Fecha de certificado de retención en recibos.
UPDATE AD_PrintFormatItem SET PrintName='Fecha de Certificado de Retención', Name='Fecha de Certificado de Retención' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001181)
;

-- 02/08/2021 16:43:11 ART
-- ISSUE #81: Fecha de certificado de retención en recibos.
UPDATE AD_Element_Trl SET Name='Fecha de Certificado de Retención',PrintName='Fecha de Certificado de Retención',Updated=TO_TIMESTAMP('2021-08-02 16:43:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001181 AND AD_Language='es_AR'
;

-- 02/08/2021 16:44:00 ART
-- ISSUE #81: Fecha de certificado de retención en recibos.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007322,29,'Y','N','N',3004171,'N','Y',3000013,'N','LAR','Fecha de Certificado de Retención',100,0,TO_TIMESTAMP('2021-08-02 16:43:59','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2021-08-02 16:43:59','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #81: Fecha de certificado de retención en recibos.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2021-08-02 16:46:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007322
;

-- 02/08/2021 16:48:20 ART
-- ISSUE #81: Fecha de certificado de retención en recibos.
UPDATE AD_Field SET DisplayLogic='@C_Invoice_ID@^'''' &  @EsRetencionSufrida@=''Y''',Updated=TO_TIMESTAMP('2021-08-02 16:48:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007322
;

-- 02/08/2021 16:48:33 ART
-- ISSUE #81: Fecha de certificado de retención en recibos.
UPDATE AD_Field SET DisplayLogic='@C_Invoice_ID@^'''' &  @EsRetencionSufrida@=''Y''',Updated=TO_TIMESTAMP('2021-08-02 16:48:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000325
;

-- Registración de script
SELECT register_migration_script_lar('0188_ISSUE-81.sql', 'LAR', '')
;
