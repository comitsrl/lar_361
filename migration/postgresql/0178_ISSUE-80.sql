...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001140,'esqr','LAR','esqr','esqr',0,TO_TIMESTAMP('2021-06-10 20:39:10','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2021-06-10 20:39:10','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- 10/06/2021 20:39:11 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,IsMandatory,Version,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003928,3000031,'LAR','Y',0,'N','N','N',1,'N',20,'N',3001140,'N','Y','N','esqr','esqr',TO_TIMESTAMP('2021-06-10 20:39:10','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_TIMESTAMP('2021-06-10 20:39:10','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Column SET Name='Es QR', ColumnName='EsQR',Updated=TO_TIMESTAMP('2021-06-10 20:39:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003928
;
...
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Element SET ColumnName='EsQR', Name='Es QR', PrintName='Es QR',Updated=TO_TIMESTAMP('2021-06-10 20:39:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001140
;
...
-- 10/06/2021 20:39:57 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_PrintFormatItem SET PrintName='Es QR', Name='Es QR' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001140)
;

-- 10/06/2021 20:40:05 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Element_Trl SET Name='Es QR',PrintName='Es QR',Updated=TO_TIMESTAMP('2021-06-10 20:40:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001140 AND AD_Language='es_AR'
;

-- 10/06/2021 20:40:12 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Column_Trl SET Name='Es QR',Updated=TO_TIMESTAMP('2021-06-10 20:40:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003928 AND AD_Language='es_AR'
;

-- 10/06/2021 20:40:43 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3007055,1,'Y','N','N',3003928,'N','Y',3000052,'N','LAR','Es QR',100,0,'Y',TO_TIMESTAMP('2021-06-10 20:40:42','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2021-06-10 20:40:42','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2021-06-10 20:42:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007055
;

-- 10/06/2021 20:45:54 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2021-06-10 20:45:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3003310
;

-- 10/06/2021 20:47:32 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001141,'lar_quick_response_id','LAR','lar_quick_response_id','lar_quick_response_id',0,TO_TIMESTAMP('2021-06-10 20:47:31','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2021-06-10 20:47:31','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- 10/06/2021 20:47:32 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,IsMandatory,Version,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003929,335,'LAR','N',0,'N','N','N',10,'N',19,'N',3001141,'N','Y','N','lar_quick_response_id','lar_quick_response_id',TO_TIMESTAMP('2021-06-10 20:47:31','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_TIMESTAMP('2021-06-10 20:47:31','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Element SET ColumnName='LAR_Quick_Response_ID', Name='Billetera Digital', PrintName='Billetera Digital',Updated=TO_TIMESTAMP('2021-06-10 21:08:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001141
;
...
-- 10/06/2021 21:08:00 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_PrintFormatItem SET PrintName='Billetera Digital', Name='Billetera Digital' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001141)
;

-- 10/06/2021 21:08:10 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Element_Trl SET Name='Billetera Digital',PrintName='Billetera Digital',Updated=TO_TIMESTAMP('2021-06-10 21:08:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001141 AND AD_Language='es_AR'
;

-- 10/06/2021 21:09:04 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Reference (AD_Reference_ID,ValidationType,EntityType,IsOrderByValue,Name,AD_Client_ID,AD_Org_ID,CreatedBy,Updated,IsActive,Created,UpdatedBy) VALUES (3000124,'T','LAR','N','Billetera Digital',0,0,100,TO_TIMESTAMP('2021-06-10 21:09:04','YYYY-MM-DD HH24:MI:SS'),'Y',TO_TIMESTAMP('2021-06-10 21:09:04','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Ref_Table (IsValueDisplayed,WhereClause,OrderByClause,AD_Table_ID,AD_Reference_ID,AD_Key,AD_Display,EntityType,CreatedBy,Updated,Created,AD_Client_ID,UpdatedBy,AD_Org_ID,IsActive) VALUES ('N','EsQR = ''Y''','Description',3000031,3000124,3001045,3001055,'LAR',100,TO_TIMESTAMP('2021-06-10 21:10:15','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2021-06-10 21:10:15','YYYY-MM-DD HH24:MI:SS'),0,100,0,'Y')
;

-- 10/06/2021 21:12:02 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Column SET AD_Reference_Value_ID=3000124, AD_Reference_ID=18, Name='Billetera Digital', ColumnName='LAR_Quick_Response_ID',Updated=TO_TIMESTAMP('2021-06-10 21:12:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003929
;

-- 10/06/2021 21:12:11 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Column_Trl SET Name='Billetera Digital',Updated=TO_TIMESTAMP('2021-06-10 21:12:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003929 AND AD_Language='es_AR'
;

-- 10/06/2021 21:12:42 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3007056,10,'Y','N','N',3003929,'N','Y',3000200,'N','LAR','Billetera Digital',100,0,'Y',TO_TIMESTAMP('2021-06-10 21:12:42','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2021-06-10 21:12:42','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,IsMandatory,Version,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003930,3000034,'LAR','N',0,'N','N','N',10,'N',19,'N',3001141,'N','Y','N','Billetera Digital','LAR_Quick_Response_ID',TO_TIMESTAMP('2021-06-10 21:19:39','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_TIMESTAMP('2021-06-10 21:19:39','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Column SET AD_Reference_Value_ID=3000124, AD_Reference_ID=18,Updated=TO_TIMESTAMP('2021-06-10 21:20:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003930
;

-- 10/06/2021 21:21:09 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Table SET AD_Window_ID=3000028,Updated=TO_TIMESTAMP('2021-06-10 21:21:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=3000034
;

-- 10/06/2021 21:21:22 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3007073,10,'Y','N','N',3003930,'N','Y',3000055,'N','LAR','Billetera Digital',100,0,'Y',TO_TIMESTAMP('2021-06-10 21:21:21','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2021-06-10 21:21:21','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Ref_List (AD_Ref_List_ID,AD_Reference_ID,EntityType,Value,Name,Updated,CreatedBy,Created,UpdatedBy,AD_Org_ID,IsActive,AD_Client_ID) VALUES (3000265,214,'LAR','Q','Billetera Digital',TO_TIMESTAMP('2021-06-10 21:22:57','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-10 21:22:57','YYYY-MM-DD HH24:MI:SS'),100,0,'Y',0)
;
...
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Field SET DisplayLogic='@TenderType@=Q',Updated=TO_TIMESTAMP('2021-06-10 21:23:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007073
;

-- 10/06/2021 21:24:58 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Column SET ReadOnlyLogic=NULL,Updated=TO_TIMESTAMP('2021-06-10 21:24:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001086
;

-- 10/06/2021 21:37:41 ART
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Ref_Table SET AD_Display=3001053,Updated=TO_TIMESTAMP('2021-06-10 21:37:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=3000124
;

-- 11/06/2021 20:12:10 ART
-- ISSUE #80: Nueva forma de pago QR.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001142,'BilleteraDigitalTotalAmt','LAR','Total Billetera Digital','Total Billetera Digital',0,TO_TIMESTAMP('2021-06-11 20:12:07','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2021-06-11 20:12:07','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ISSUE #80: Nueva forma de pago QR.
UPDATE AD_Ref_List SET IsActive='N',Updated=TO_TIMESTAMP('2021-06-11 21:17:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Ref_List_ID=3000265
;

-- Registración de script
SELECT register_migration_script_lar('0178_ISSUE-80.sql', 'LAR', '')
;
