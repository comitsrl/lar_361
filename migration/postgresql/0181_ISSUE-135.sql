...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001144,'copiarlineasorigen','LAR','copiarlineasorigen','copiarlineasorigen',0,TO_TIMESTAMP('2021-06-18 19:39:35','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2021-06-18 19:39:35','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- 18/06/2021 19:39:36 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003978,318,'LAR',0,'N','N','N','N',1,'N',20,'N',3001144,'N','Y','N','copiarlineasorigen','copiarlineasorigen',100,TO_TIMESTAMP('2021-06-18 19:39:35','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2021-06-18 19:39:35','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Column SET AD_Reference_ID=28, Name='Copiar Líneas desde Factura Origen', ColumnName='CopiarLineasOrigen',Updated=TO_TIMESTAMP('2021-06-18 19:41:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003978
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Element SET ColumnName='CopiarLineasOrigen', Name='Copiar Líneas desde Factura Origen', PrintName='Copiar Líneas desde Factura Origen',Updated=TO_TIMESTAMP('2021-06-18 19:41:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001144
;
...
-- 18/06/2021 19:41:43 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_PrintFormatItem SET PrintName='Copiar Líneas desde Factura Origen', Name='Copiar Líneas desde Factura Origen' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001144)
;

-- 18/06/2021 19:41:49 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Element_Trl SET Name='Copiar Líneas desde Factura Origen',PrintName='Copiar Líneas desde Factura Origen',Updated=TO_TIMESTAMP('2021-06-18 19:41:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001144 AND AD_Language='es_AR'
;

-- 18/06/2021 19:42:10 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Column_Trl SET Name='Copiar Líneas desde Factura Origen',Updated=TO_TIMESTAMP('2021-06-18 19:42:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003978 AND AD_Language='es_AR'
;

-- 18/06/2021 19:42:47 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007076,1,'Y','N','N',3003978,'N','Y',263,'N','LAR','Copiar Líneas desde Factura Origen',100,0,TO_TIMESTAMP('2021-06-18 19:42:47','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2021-06-18 19:42:47','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Field SET DisplayLogic='@TargetDocBaseType@=''ARC'' | @DocSubTypeCAE@=202 | @DocSubTypeCAE@=2 | @DocSubTypeCAE@=207 | @DocSubTypeCAE@=7 | @DocSubTypeCAE@=212 | @DocSubTypeCAE@=52',Updated=TO_TIMESTAMP('2021-06-18 19:43:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007076
;

-- 18/06/2021 19:47:37 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
INSERT INTO AD_Process (AD_Process_ID,IsDirectPrint,IsReport,AccessLevel,IsBetaFunctionality,IsServerProcess,ShowHelp,EntityType,Statistic_Seconds,Statistic_Count,Classname,Description,Value,Name,AD_Org_ID,AD_Client_ID,UpdatedBy,Created,CreatedBy,Updated,IsActive) VALUES (3000421,'N','N','1','N','N','Y','LAR',2605,1379,'ar.com.ergio.process.LAR_CopiarLineasFacturaOrigen','Copiar líneas desde Factura Origen.','LAR_CopiarLineasFacturaOrigen','LAR_CopiarLineasFacturaOrigen',0,0,100,TO_TIMESTAMP('2021-06-18 19:47:37','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-18 19:47:37','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Column SET AD_Process_ID=3000421,Updated=TO_TIMESTAMP('2021-06-18 19:49:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003978
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2021-06-18 19:50:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007076
;

-- 18/06/2021 20:00:02 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Column SET Callout=NULL,Updated=TO_TIMESTAMP('2021-06-18 20:00:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000265
;

-- 22/06/2021 18:40:55 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003979,259,'LAR',0,'N','N','N','N',1,'N',20,'N',3001144,'N','Y','N','Copiar Líneas desde Factura Origen','CopiarLineasOrigen',100,TO_TIMESTAMP('2021-06-22 18:40:54','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2021-06-22 18:40:54','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
INSERT INTO AD_Process (AD_Process_ID,IsDirectPrint,IsReport,AccessLevel,IsBetaFunctionality,IsServerProcess,ShowHelp,EntityType,Statistic_Seconds,Statistic_Count,Classname,Description,Value,Name,AD_Org_ID,AD_Client_ID,UpdatedBy,Created,CreatedBy,Updated,IsActive) VALUES (3000423,'N','N','1','N','N','Y','U',2612,1383,'ar.com.ergio.process.LAR_CopiarLineasFacturaOrigenON','Copiar líneas desde Factura Origen.','LAR_CopiarLineasFacturaOrigenON','LAR_CopiarLineasFacturaOrigenON',0,0,100,TO_TIMESTAMP('2021-06-22 18:42:16','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2021-06-22 18:42:16','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Column SET AD_Reference_ID=28, AD_Process_ID=3000423,Updated=TO_TIMESTAMP('2021-06-22 18:42:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003979
;

-- 22/06/2021 18:43:25 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007116,1,'Y','N','N',3003979,'N','Y',186,'N','LAR','Copiar Líneas desde Factura Origen',100,0,TO_TIMESTAMP('2021-06-22 18:43:25','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2021-06-22 18:43:25','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Column SET Callout=NULL,Updated=TO_TIMESTAMP('2021-06-22 18:48:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3001210
;

-- 22/06/2021 20:25:13 ART
-- ISSUE #135: Compatibilizar mensajes al usuario, con la versión Web del ERP.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2021-06-22 20:25:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007116
;
