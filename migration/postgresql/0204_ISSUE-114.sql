...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001231,'montomonedext','LAR','montomonedext','montomonedext',0,TO_TIMESTAMP('2021-12-21 15:15:09','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2021-12-21 15:15:09','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Column SET FieldLength=20, AD_Reference_ID=12, Name='Monto en Moneda Ext.', ColumnName='MontoMonedExt',Updated=TO_TIMESTAMP('2021-12-21 15:16:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004422
;
...
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Column_Trl SET Name='Monto en Moneda Ext.',Updated=TO_TIMESTAMP('2021-12-21 15:16:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004422 AND AD_Language='es_AR'
;

-- 21/12/2021 15:16:58 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Element SET ColumnName='MontoMonedExt', Name='Monto en Moneda Ext.', PrintName='Monto en Moneda Ext.',Updated=TO_TIMESTAMP('2021-12-21 15:16:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001231
;
...
-- 21/12/2021 15:16:58 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_PrintFormatItem SET PrintName='Monto en Moneda Ext.', Name='Monto en Moneda Ext.' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001231)
;

-- 21/12/2021 15:17:06 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Element_Trl SET Name='Monto en Moneda Ext.',PrintName='Monto en Moneda Ext.',Updated=TO_TIMESTAMP('2021-12-21 15:17:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001231 AND AD_Language='es_AR'
;

-- 21/12/2021 15:19:01 ART
-- ISSUE 60: Mejorar registro de scripts de migración
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007721,20,'Y','N','N',3004422,3000016,'N','Y','N','LAR','Monto en Moneda Ext.',100,0,TO_TIMESTAMP('2021-12-21 15:19:00','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2021-12-21 15:19:00','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET AD_FieldGroup_ID=103,Updated=TO_TIMESTAMP('2021-12-21 15:21:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007721
;
...
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Column SET ReadOnlyLogic='@LAR_PaymentSource_ID@!0  | @EsRetencionIIBB@=Y | @MontoMonedExt@!0',Updated=TO_TIMESTAMP('2021-12-21 18:04:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=5303
;

-- 21/12/2021 18:04:42 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2021-12-21 18:04:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000442
;

-- 21/12/2021 18:04:52 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2021-12-21 18:04:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000443
;

-- 21/12/2021 18:21:52 ART
-- ISSUE 60: Mejorar registro de scripts de migración
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001232,'generapagodifcambio','LAR','generapagodifcambio','generapagodifcambio',0,TO_TIMESTAMP('2021-12-21 18:21:51','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2021-12-21 18:21:51','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- 21/12/2021 18:21:52 ART
-- ISSUE 60: Mejorar registro de scripts de migración
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3004423,3000010,'LAR',0,'Y','N','N','N',1,'N',20,'N',3001232,'N','Y','N','generapagodifcambio','generapagodifcambio',TO_TIMESTAMP('2021-12-21 18:21:51','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_TIMESTAMP('2021-12-21 18:21:51','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Element SET ColumnName='GeneraPagoDifCambio', Name='Generar Pago x Dif. de Cambio', PrintName='Generar Pago x Dif. de Cambio',Updated=TO_TIMESTAMP('2021-12-21 18:22:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001232
;
...
-- 21/12/2021 18:22:55 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_PrintFormatItem SET PrintName='Generar Pago x Dif. de Cambio', Name='Generar Pago x Dif. de Cambio' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001232)
;

-- 21/12/2021 18:23:11 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Element_Trl SET Name='Generar Pago x Dif. de Cambio',PrintName='Generar Pago x Dif. de Cambio',Updated=TO_TIMESTAMP('2021-12-21 18:23:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001232 AND AD_Language='es_AR'
;

-- 21/12/2021 18:23:42 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Column_Trl SET Name='Generar Pago x Dif. de Cambio',Updated=TO_TIMESTAMP('2021-12-21 18:23:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004423 AND AD_Language='es_AR'
;

-- 21/12/2021 18:24:12 ART
-- ISSUE 60: Mejorar registro de scripts de migración
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,AD_Tab_ID,IsFieldOnly,IsCentrallyMaintained,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007723,1,'Y','N','N',3004423,3000015,'N','Y','N','LAR','Generar Pago x Dif. de Cambio',100,0,TO_TIMESTAMP('2021-12-21 18:24:12','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2021-12-21 18:24:12','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2021-12-21 18:25:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007723
;

-- 21/12/2021 18:25:44 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET DefaultValue='Y',Updated=TO_TIMESTAMP('2021-12-21 18:25:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007723
;

-- 21/12/2021 18:26:26 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Field SET DisplayLogic='@TasaDelDia@ > 0',Updated=TO_TIMESTAMP('2021-12-21 18:26:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007723
;

-- 22/12/2021 12:38:09 ART
-- ISSUE 60: Mejorar registro de scripts de migración
UPDATE AD_Column SET Callout='org.compiere.model.CalloutPayment.montoMonedaExt',Updated=TO_TIMESTAMP('2021-12-22 12:38:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004422
;

-- Registración de script
SELECT register_migration_script_lar('0204_ISSUE-114.sql', 'LAR', '')
;
