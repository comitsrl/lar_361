...
-- ISSUE  #77: Facturación Electronica
INSERT INTO LCO_TaxPayerType (AD_Client_ID,AD_Org_ID,Created,CreatedBy,Description,UpdatedBy,IsDefault,LCO_TaxPayerType_ID,IsActive,Updated,Name) VALUES (1000000,0,TO_TIMESTAMP('2017-08-14 21:21:24','YYYY-MM-DD HH24:MI:SS'),100,'Responsable InscriptoM',100,'Y',1000005,'Y',TO_TIMESTAMP('2017-08-14 21:21:24','YYYY-MM-DD HH24:MI:SS'),'ResponsableInscriptoM')
;

-- 14/08/2017 21:22:16 ART
-- ISSUE  #77: Facturación Electronica
UPDATE LAR_LetterRule SET LCO_TaxPayerType_Vendor_ID=1000005,Updated=TO_TIMESTAMP('2017-08-14 21:22:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE LAR_LetterRule_ID=1000005
;

-- 14/08/2017 21:22:31 ART
-- ISSUE  #77: Facturación Electronica
UPDATE LAR_LetterRule SET LCO_TaxPayerType_Customer_ID=1000005,Updated=TO_TIMESTAMP('2017-08-14 21:22:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE LAR_LetterRule_ID=1000005
;
