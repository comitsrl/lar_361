...
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3001238,'fechaop','LAR','fechaop','fechaop',0,TO_TIMESTAMP('2022-03-02 18:54:00','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2022-03-02 18:54:00','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Element SET ColumnName='FechaOP', Name='Fecha de Orden de Pago', PrintName='Fecha de Orden de Pago',Updated=TO_TIMESTAMP('2022-03-02 18:55:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001238
;
...
-- 02/03/2022 18:55:01 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_PrintFormatItem SET PrintName='Fecha de Orden de Pago', Name='Fecha de Orden de Pago' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001238)
;

-- 02/03/2022 18:55:06 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Element_Trl SET Name='Fecha de Orden de Pago',PrintName='Fecha de Orden de Pago',Updated=TO_TIMESTAMP('2022-03-02 18:55:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001238 AND AD_Language='es_AR'
;

-- 02/03/2022 18:55:20 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Column_Trl SET Name='Fecha de Orden de Pago',Updated=TO_TIMESTAMP('2022-03-02 18:55:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004436 AND AD_Language='es_AR'
;

-- 02/03/2022 18:55:47 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Column SET AD_Reference_ID=15,Updated=TO_TIMESTAMP('2022-03-02 18:55:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004436
;

-- 02/03/2022 18:57:33 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Column SET MandatoryLogic='@IsReceipt@=''Y'' & @C_CurrencyTo_ID@ > 0',Updated=TO_TIMESTAMP('2022-03-02 18:57:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004436
;

-- 02/03/2022 18:58:24 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3007749,29,'Y','N','N',3004436,'N','Y',3000012,'N','LAR','Fecha de Orden de Pago',100,0,TO_TIMESTAMP('2022-03-02 18:58:24','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_TIMESTAMP('2022-03-02 18:58:24','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3007750,1,'Y','N','N',3004423,'N','Y',3000012,'N','LAR','Generar Pago x Dif. de Cambio',100,0,TO_TIMESTAMP('2022-03-02 18:58:24','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_TIMESTAMP('2022-03-02 18:58:24','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2022-03-02 19:03:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007749
;

-- 02/03/2022 19:05:11 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3007752,29,'Y','N','N',3004436,'N','Y',3000015,'N','LAR','Fecha de Orden de Pago',100,0,TO_TIMESTAMP('2022-03-02 19:05:11','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_TIMESTAMP('2022-03-02 19:05:11','YYYY-MM-DD HH24:MI:SS'))
;
...
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Field SET DisplayLogic='@IsReceipt@=''Y'' & @C_CurrencyTo_ID@ > 0',Updated=TO_TIMESTAMP('2022-03-02 19:07:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007749
;

-- 02/03/2022 19:16:03 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Field SET IsCentrallyMaintained='N',Updated=TO_TIMESTAMP('2022-03-02 19:16:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007681
;

-- 02/03/2022 19:16:09 ART
-- ISSUE #114: Recuperar tasa del dia automaticamente en Recibos/OP.
UPDATE AD_Field_Trl SET IsTranslated='Y',Name='Calcular Dif. de Cambio',Updated=TO_TIMESTAMP('2022-03-02 19:16:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3007681 AND AD_Language='es_AR'
;

-- Registración de script
SELECT register_migration_script_lar('0206_ISSUE-114.sql', 'LAR', '')
;
