...
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,Help,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Description,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3003364,3000010,'LAR',0,'N','N','N','A description is limited to 255 characters.','N',255,'Y',10,'N',275,'N','Y','N','Optional short description of the record','Description','Description',TO_TIMESTAMP('2018-12-17 18:18:27','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_TIMESTAMP('2018-12-17 18:18:27','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #118: Correcciones ventana Recibos / Ordenes de Pago.
UPDATE AD_Column SET Callout='org.compiere.model.CalloutPayment.tenderType',Updated=TO_TIMESTAMP('2018-12-17 19:37:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=5046
;

-- Registración de script
SELECT register_migration_script_lar('0124_ISSUE-118.sql', 'LAR', '')
;
