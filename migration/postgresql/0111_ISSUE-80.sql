ALTER TABLE C_BankStatement ADD COLUMN SaldoFinal numeric DEFAULT 0;

-- 27/07/2018 19:04:23 ART
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3000869,'saldofinal','LAR','saldofinal','saldofinal',0,TO_TIMESTAMP('2018-07-27 19:04:22','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2018-07-27 19:04:22','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- 27/07/2018 19:04:24 ART
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3002970,392,'LAR',0,'N','N','N','N',131089,'N',22,'N',3000869,'N','Y','N','saldofinal','saldofinal',100,TO_TIMESTAMP('2018-07-27 19:04:22','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2018-07-27 19:04:22','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
UPDATE AD_Column SET Name='Saldo del Cierre', ColumnName='SaldoFinal',Updated=TO_TIMESTAMP('2018-07-27 19:04:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002970
;
...
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
UPDATE AD_Column SET FieldLength=20,Updated=TO_TIMESTAMP('2018-07-27 19:05:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002970
;

-- 27/07/2018 19:05:16 ART
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
UPDATE AD_Column SET AD_Reference_ID=37,Updated=TO_TIMESTAMP('2018-07-27 19:05:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002970
;

-- 27/07/2018 19:05:21 ART
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
UPDATE AD_Column_Trl SET Name='Saldo del Cierre',Updated=TO_TIMESTAMP('2018-07-27 19:05:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002970 AND AD_Language='es_AR'
;

-- 27/07/2018 19:05:35 ART
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
UPDATE AD_Element SET ColumnName='SaldoFinal', Name='Saldo del Cierre', PrintName='Saldo del Cierre',Updated=TO_TIMESTAMP('2018-07-27 19:05:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000869
;
...
-- 27/07/2018 19:05:36 ART
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
UPDATE AD_PrintFormatItem SET PrintName='Saldo del Cierre', Name='Saldo del Cierre' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3000869)
;

-- 27/07/2018 19:05:41 ART
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
UPDATE AD_Element_Trl SET Name='Saldo del Cierre',PrintName='Saldo del Cierre',Updated=TO_TIMESTAMP('2018-07-27 19:05:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000869 AND AD_Language='es_AR'
;

-- 27/07/2018 19:06:33 ART
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3005562,20,'Y','N','N',3002970,'N','Y',3000007,'N','LAR','Saldo del Cierre',100,0,TO_TIMESTAMP('2018-07-27 19:06:32','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2018-07-27 19:06:32','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Columna Saldo Final, para cierres de caja.
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2018-07-27 19:24:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3005562
;

-- Registración de script
SELECT register_migration_script_lar('0111_ISSUE-80.sql', 'LAR', '')
;
