...
UPDATE AD_Message_Trl SET MsgText='Código',Updated=TO_TIMESTAMP('2018-01-05 21:22:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Message_ID=592 AND AD_Language='es_AR'
;

-- Registración de script
SELECT register_migration_script_lar('0102_ISSUE-104.sql', 'LAR', '')
;
