...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,CreatedBy,UpdatedBy,AD_Org_ID) VALUES (3000461,'lar_cierrecaja_origen_id','LAR','lar_cierrecaja_origen_id','lar_cierrecaja_origen_id',0,TO_TIMESTAMP('2017-08-23 16:46:15','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2017-08-23 16:46:15','YYYY-MM-DD HH24:MI:SS'),'Y',100,100,0)
;
...
-- 23/08/2017 16:46:17 ART
-- ISSUE #80: Cierre de Cajas.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3002114,392,'LAR',0,'N','N','N','N',10,'N',19,'N',3000461,'N','Y','N','lar_cierrecaja_origen_id','lar_cierrecaja_origen_id',100,TO_TIMESTAMP('2017-08-23 16:46:15','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2017-08-23 16:46:15','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column SET Name='Cierre Origen', ColumnName='LAR_CierreCaja_Origen_ID',Updated=TO_TIMESTAMP('2017-08-23 16:47:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002114
;
...
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Column_Trl SET Name='Cierre Origen',Updated=TO_TIMESTAMP('2017-08-23 16:47:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3002114 AND AD_Language='es_AR'
;

-- 23/08/2017 16:48:21 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element SET ColumnName='LAR_CierreCaja_Origen_ID', Name='Cierre Origen', PrintName='Cierre Origen',Updated=TO_TIMESTAMP('2017-08-23 16:48:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000461
;
...
-- 23/08/2017 16:48:21 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_PrintFormatItem SET PrintName='Cierre Origen', Name='Cierre Origen' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3000461)
;

-- 23/08/2017 16:48:27 ART
-- ISSUE #80: Cierre de Cajas.
UPDATE AD_Element_Trl SET Name='Cierre Origen',PrintName='Cierre Origen',Updated=TO_TIMESTAMP('2017-08-23 16:48:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000461 AND AD_Language='es_AR'
;

-- 23/08/2017 16:49:35 ART
-- ISSUE #80: Cierre de Cajas.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3003355,10,'Y','N','N',3002114,'N','Y',3000007,'N','LAR','Cierre Origen',100,0,TO_TIMESTAMP('2017-08-23 16:49:34','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2017-08-23 16:49:34','YYYY-MM-DD HH24:MI:SS'),100)
;
