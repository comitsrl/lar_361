...
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001394,'scrutinizedbilleteradigital','LAR','scrutinizedbilleteradigital','scrutinizedbilleteradigital',0,TO_TIMESTAMP('2023-05-21 23:44:01','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2023-05-21 23:44:01','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- 21/05/2023 23:44:03 ART
-- BUG #377: Ajustes de Ventanas y traducciones
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,IsMandatory,Version,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3005575,392,'LAR','Y',0,'N','N','N',14,'N',22,'N',3001394,'N','Y','N','scrutinizedbilleteradigital','scrutinizedbilleteradigital',TO_TIMESTAMP('2023-05-21 23:44:01','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_TIMESTAMP('2023-05-21 23:44:01','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column SET Name='ScrutinizedBilleteraDigital', ColumnName='ScrutinizedBilleteraDigital',Updated=TO_TIMESTAMP('2023-05-21 23:44:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005575
;
...
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column SET Name='Billetera Digital Contabilizado',Updated=TO_TIMESTAMP('2023-05-21 23:45:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005575
;
...
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column_Trl SET Name='Billetera Digital Contabilizado',Updated=TO_TIMESTAMP('2023-05-21 23:45:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005575 AND AD_Language='es_AR'
;

-- 21/05/2023 23:45:57 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Element SET ColumnName='ScrutinizedBilleteraDigital', Name='Billetera Digital Contabilizado', PrintName='Billetera Digital Contabilizado',Updated=TO_TIMESTAMP('2023-05-21 23:45:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001394
;
...
-- 21/05/2023 23:45:57 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_PrintFormatItem SET PrintName='Billetera Digital Contabilizado', Name='Billetera Digital Contabilizado' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001394)
;

-- 21/05/2023 23:46:05 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Element_Trl SET Name='Billetera Digital Contabilizado',PrintName='Billetera Digital Contabilizado',Updated=TO_TIMESTAMP('2023-05-21 23:46:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001394 AND AD_Language='es_AR'
;

-- 21/05/2023 23:46:25 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column SET AD_Reference_ID=12,Updated=TO_TIMESTAMP('2023-05-21 23:46:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005575
;

-- 21/05/2023 23:50:05 ART
-- BUG #377: Ajustes de Ventanas y traducciones
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001395,'BilleteraDigitalDifference','LAR','Diferencia Billetera Digital','Diferencia Billetera Digital',0,TO_TIMESTAMP('2023-05-21 23:50:04','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2023-05-21 23:50:04','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2023-05-22 00:02:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3008596
;

-- 22/05/2023 0:02:47 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2023-05-22 00:02:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3008597
;

-- 22/05/2023 0:08:14 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column SET ColumnSQL='((SELECT (C_BankStatement.ScrutinizedCashAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType = ''X'')) + (SELECT (C_BankStatement.ScrutinizedCheckAmt - ((SELECT COALESCE(Sum(sl.TrxAmt),0) FROM C_BankStatementLine sl  JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN (''K'',''Z'') AND p.LAR_Cheque_Emitido_ID IS NULL AND p.EsElectronico = ''N'')) + (COALESCE((SELECT SUM(pa.PayAmt)  FROM C_Payment pa WHERE pa.C_BankAccount_ID=C_BankStatement.C_BankAccount_ID AND pa.IsOnDrawer=''Y'' AND pa.IsReceipt=''Y'' AND pa.DocStatus IN (''CO'',''CL'') AND pa.TenderType IN (''K'',''Z'') AND pa.EsElectronico = ''N'' AND pa.C_Payment_ID NOT IN (SELECT sli.C_Payment_ID  FROM C_BankStatementLine sli  WHERE C_BankStatement.C_BankStatement_ID=sli.C_BankStatement_ID)) , 0)) + (COALESCE((SELECT SUM(pa.PayAmt) FROM C_Payment pa WHERE pa.C_BankAccount_ID=C_BankStatement.C_BankAccount_ID AND pa.IsReceipt=''N'' AND pa.DocStatus IN (''CO'',''CL'') AND pa.TenderType IN (''K'',''Z'') AND pa.EsElectronico = ''N'' AND pa.IsReconciled=''N'' AND pa.LAR_Cheque_Emitido_ID IS NULL AND pa.LAR_PaymentSource_ID > 0 AND pa.LAR_PaymentSource_ID NOT IN (SELECT sli.C_Payment_ID  FROM C_BankStatementLine sli  WHERE C_BankStatement.C_BankStatement_ID=sli.C_BankStatement_ID)) , 0))))) + (SELECT (C_BankStatement.ScrutinizedCreditCardAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN (''D'', ''C'')) + (SELECT COALESCE(Sum(TrxAmt),0) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType = ''Q''))) - C_BankStatement.SaldoInicial)',Updated=TO_TIMESTAMP('2023-05-22 00:08:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000161
;
...
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column SET ColumnSQL='((SELECT(C_BankStatement.ScrutinizedCashAmt-(COALESCE(Sum(TrxAmt),0)))FROM C_BankStatementLine sl JOIN C_Payment p ON(sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType=''X'')) + (SELECT (C_BankStatement.ScrutinizedCheckAmt - ((SELECT COALESCE(Sum(sl.TrxAmt),0) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN(''K'',''Z'') AND p.LAR_Cheque_Emitido_ID IS NULL AND p.EsElectronico=''N'')) + (COALESCE((SELECT SUM(pa.PayAmt) FROM C_Payment pa WHERE pa.C_BankAccount_ID=C_BankStatement.C_BankAccount_ID AND pa.IsOnDrawer=''Y'' AND pa.IsReceipt=''Y'' AND pa.DocStatus IN(''CO'',''CL'') AND pa.TenderType IN(''K'',''Z'') AND pa.EsElectronico = ''N'' AND pa.C_Payment_ID NOT IN(SELECT sli.C_Payment_ID FROM C_BankStatementLine sli WHERE C_BankStatement.C_BankStatement_ID=sli.C_BankStatement_ID)),0)) + (COALESCE((SELECT SUM(pa.PayAmt) FROM C_Payment pa WHERE pa.C_BankAccount_ID=C_BankStatement.C_BankAccount_ID AND pa.IsReceipt=''N'' AND pa.DocStatus IN(''CO'',''CL'') AND pa.TenderType IN(''K'',''Z'') AND pa.EsElectronico=''N'' AND pa.IsReconciled=''N'' AND pa.LAR_Cheque_Emitido_ID IS NULL AND pa.LAR_PaymentSource_ID>0 AND pa.LAR_PaymentSource_ID NOT IN(SELECT sli.C_Payment_ID FROM C_BankStatementLine sli WHERE C_BankStatement.C_BankStatement_ID=sli.C_BankStatement_ID)),0))))) + (SELECT(C_BankStatement.ScrutinizedCreditCardAmt -(COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON(sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType IN(''D'', ''C''))) + (SELECT (C_BankStatement.ScrutinizedBilleteraDigital - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType=''Q'')) - C_BankStatement.SaldoInicial)',Updated=TO_TIMESTAMP('2023-05-22 01:16:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000161
;

-- 22/05/2023 1:22:26 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column SET ColumnSQL='((SELECT(C_BankStatement.ScrutinizedCashAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON(sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType=''X'')) + (SELECT(C_BankStatement.ScrutinizedCheckAmt - ((SELECT COALESCE(Sum(sl.TrxAmt),0) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID = sl.C_BankStatement_ID AND p.TenderType IN(''K'',''Z'') AND p.LAR_Cheque_Emitido_ID IS NULL AND p.EsElectronico=''N'')) + (COALESCE((SELECT SUM(pa.PayAmt) FROM C_Payment pa WHERE pa.C_BankAccount_ID=C_BankStatement.C_BankAccount_ID AND pa.IsOnDrawer=''Y'' AND pa.IsReceipt=''Y'' AND pa.DocStatus IN(''CO'',''CL'') AND pa.TenderType IN(''K'',''Z'') AND pa.EsElectronico = ''N'' AND pa.C_Payment_ID NOT IN(SELECT sli.C_Payment_ID FROM C_BankStatementLine sli WHERE C_BankStatement.C_BankStatement_ID=sli.C_BankStatement_ID)),0)) + (COALESCE((SELECT SUM(pa.PayAmt) FROM C_Payment pa WHERE pa.C_BankAccount_ID=C_BankStatement.C_BankAccount_ID AND pa.IsReceipt=''N'' AND pa.DocStatus IN(''CO'',''CL'') AND pa.TenderType IN(''K'',''Z'') AND pa.EsElectronico=''N'' AND pa.IsReconciled=''N'' AND pa.LAR_Cheque_Emitido_ID IS NULL AND pa.LAR_PaymentSource_ID>0 AND pa.LAR_PaymentSource_ID NOT IN(SELECT sli.C_Payment_ID FROM C_BankStatementLine sli WHERE C_BankStatement.C_BankStatement_ID=sli.C_BankStatement_ID)),0))))) + (SELECT(C_BankStatement.ScrutinizedCreditCardAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON(sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType IN(''D'',''C''))) + (SELECT (C_BankStatement.ScrutinizedBilleteraDigital - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType=''Q'')) - C_BankStatement.SaldoInicial)',Updated=TO_TIMESTAMP('2023-05-22 01:22:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000161
;

-- 22/05/2023 1:37:32 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Column SET ColumnSQL='((SELECT (C_BankStatement.ScrutinizedCashAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType=''X'')) + (SELECT (C_BankStatement.ScrutinizedCheckAmt - ((SELECT COALESCE(Sum(sl.TrxAmt),0) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID = p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType IN (''K'',''Z'') AND p.LAR_Cheque_Emitido_ID IS NULL AND p.EsElectronico=''N'')) + (COALESCE((SELECT SUM(pa.PayAmt) FROM C_Payment pa WHERE pa.C_BankAccount_ID=C_BankStatement.C_BankAccount_ID AND pa.IsOnDrawer=''Y'' AND pa.IsReceipt=''Y'' AND pa.DocStatus IN (''CO'',''CL'') AND pa.TenderType IN (''K'',''Z'') AND pa.EsElectronico=''N'' AND pa.C_Payment_ID NOT IN (SELECT sli.C_Payment_ID FROM C_BankStatementLine sli WHERE C_BankStatement.C_BankStatement_ID=sli.C_BankStatement_ID)),0)) + (COALESCE((SELECT SUM(pa.PayAmt) FROM C_Payment pa WHERE pa.C_BankAccount_ID=C_BankStatement.C_BankAccount_ID AND pa.IsReceipt=''N'' AND pa.DocStatus IN (''CO'',''CL'') AND pa.TenderType IN (''K'',''Z'') AND pa.EsElectronico=''N'' AND pa.IsReconciled=''N'' AND pa.LAR_Cheque_Emitido_ID IS NULL AND pa.LAR_PaymentSource_ID > 0 AND pa.LAR_PaymentSource_ID NOT IN (SELECT sli.C_Payment_ID FROM C_BankStatementLine sli WHERE C_BankStatement.C_BankStatement_ID=sli.C_BankStatement_ID)),0))))) + (SELECT (C_BankStatement.ScrutinizedCreditCardAmt - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType IN (''D'',''C''))) + (SELECT (C_BankStatement.ScrutinizedBilleteraDigital - (COALESCE(Sum(TrxAmt),0))) FROM C_BankStatementLine sl JOIN C_Payment p ON (sl.C_Payment_ID=p.C_Payment_ID) WHERE (C_BankStatement.C_BankStatement_ID=sl.C_BankStatement_ID AND p.TenderType=''Q'')) - C_BankStatement.SaldoInicial)',Updated=TO_TIMESTAMP('2023-05-22 01:37:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000161
;

-- Registración de script
SELECT register_migration_script_lar('0220_ISSUE-80.sql', 'LAR', '')
;
