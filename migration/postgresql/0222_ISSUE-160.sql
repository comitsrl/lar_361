...
-- ISSUE #160: Ventana de Ordenes de Garantía.
UPDATE AD_Val_Rule SET Code='C_Invoice.DocStatus = ''CO'' AND C_Invoice.DateInvoiced::DATE >= (SELECT (''@FechaCambio@''::DATE - interval ''1 month'' * (SELECT MesesGarantia FROM C_BPartner WHERE C_BPartner_ID = @C_BPartner_ID@)))',Updated=TO_TIMESTAMP('2023-09-27 12:22:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=3000141
;

-- 27/09/2023 12:24:32 ART
-- ISSUE #160: Ventana de Ordenes de Garantía.
UPDATE AD_Val_Rule SET Code='C_Invoice.DateInvoiced::DATE >= (SELECT (''@FechaCambio@''::DATE - interval ''1 month'' * (SELECT MesesGarantia FROM C_BPartner WHERE C_BPartner_ID = @C_BPartner_ID@)))',Updated=TO_TIMESTAMP('2023-09-27 12:24:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Val_Rule_ID=3000141
;

-- 27/09/2023 12:27:09 ART
-- ISSUE #160: Ventana de Ordenes de Garantía.
INSERT INTO AD_Reference (AD_Reference_ID,ValidationType,EntityType,IsOrderByValue,Name,AD_Client_ID,AD_Org_ID,CreatedBy,Updated,IsActive,Created,UpdatedBy) VALUES (3000167,'T','LAR','N','C_Invoice Completas',0,0,100,TO_TIMESTAMP('2023-09-27 12:27:09','YYYY-MM-DD HH24:MI:SS'),'Y',TO_TIMESTAMP('2023-09-27 12:27:09','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- ISSUE #160: Ventana de Ordenes de Garantía.
INSERT INTO AD_Ref_Table (IsValueDisplayed,WhereClause,AD_Table_ID,AD_Reference_ID,AD_Key,AD_Display,EntityType,CreatedBy,Created,Updated,AD_Client_ID,UpdatedBy,AD_Org_ID,IsActive) VALUES ('N','C_Invoice.DocStatus = ''CO''',318,3000167,3484,3492,'LAR',100,TO_TIMESTAMP('2023-09-27 12:28:10','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2023-09-27 12:28:10','YYYY-MM-DD HH24:MI:SS'),0,100,0,'Y')
;

-- 27/09/2023 12:28:27 ART
-- ISSUE #160: Ventana de Ordenes de Garantía.
UPDATE AD_Column SET AD_Reference_Value_ID=3000167,Updated=TO_TIMESTAMP('2023-09-27 12:28:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005598
;

-- 27/09/2023 13:17:40 ART
-- ISSUE #160: Ventana de Ordenes de Garantía.
UPDATE AD_Column SET MandatoryLogic='@C_Order_ID@ > 0',Updated=TO_TIMESTAMP('2023-09-27 13:17:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005614
;

-- 27/09/2023 13:21:03 ART
-- ISSUE #160: Ventana de Ordenes de Garantía.
UPDATE AD_Column SET FieldLength=60, AD_Reference_ID=10,Updated=TO_TIMESTAMP('2023-09-27 13:21:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005619
;

-- 27/09/2023 13:21:17 ART
-- ISSUE #160: Ventana de Ordenes de Garantía.
UPDATE AD_Column SET FieldLength=60, AD_Reference_ID=10,Updated=TO_TIMESTAMP('2023-09-27 13:21:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3005620
;
