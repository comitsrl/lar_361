...
-- ISSUE #139: TaxID en ventana Pais.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,Help,EntityType,Description,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007321,20,'Y','N','N',3004170,'N','Y',135,'N','The Tax ID field identifies the legal Identification number of this Entity.','LAR','Tax Identification','Tax ID',100,0,TO_TIMESTAMP('2021-07-29 22:11:36','YYYY-MM-DD HH24:MI:SS'),'Y',0,TO_TIMESTAMP('2021-07-29 22:11:36','YYYY-MM-DD HH24:MI:SS'),100)
;
...
SELECT register_migration_script_lar('0187_ISSUE-139.sql', 'LAR', '')
;
