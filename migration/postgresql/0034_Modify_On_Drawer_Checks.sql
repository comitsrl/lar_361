...
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3000824,335,'LAR',0,'N','N','N','N',60,'N',10,'N',3000110,'N','Y','N','targetaccount','targetaccount',100,TO_TIMESTAMP('2012-09-10 07:07:01','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_TIMESTAMP('2012-09-10 07:07:01','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- On drawer Checks, new columns and fields
UPDATE AD_Element SET ColumnName='IsBounced', Name='IsBounced', PrintName='IsBounced',Updated=TO_TIMESTAMP('2012-09-10 07:08:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000111
;
...
-- 10/09/2012 7:08:06 ART
-- On drawer Checks, new columns and fields
UPDATE AD_PrintFormatItem SET PrintName='IsBounced', Name='IsBounced' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3000111)
;

-- 10/09/2012 7:09:03 ART
-- On drawer Checks, new columns and fields
UPDATE AD_Column SET IsSelectionColumn='Y', IsAlwaysUpdateable='Y',Updated=TO_TIMESTAMP('2012-09-10 07:09:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000825
;

-- 10/09/2012 7:09:28 ART
-- On drawer Checks, new columns and fields
UPDATE AD_Element SET ColumnName='IsDeposited', Name='IsDeposited', PrintName='IsDeposited',Updated=TO_TIMESTAMP('2012-09-10 07:09:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000112
;
...
-- 10/09/2012 7:09:28 ART
-- On drawer Checks, new columns and fields
UPDATE AD_PrintFormatItem SET PrintName='IsDeposited', Name='IsDeposited' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3000112)
;

-- 10/09/2012 7:09:44 ART
-- On drawer Checks, new columns and fields
UPDATE AD_Column SET IsSelectionColumn='Y',Updated=TO_TIMESTAMP('2012-09-10 07:09:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000826
;

-- 10/09/2012 7:10:24 ART
-- On drawer Checks, new columns and fields
UPDATE AD_Element SET ColumnName='TargetAccount', Name='TargetAccount', PrintName='TargetAccount',Updated=TO_TIMESTAMP('2012-09-10 07:10:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3000110
;
...
-- 10/09/2012 7:10:24 ART
-- On drawer Checks, new columns and fields
UPDATE AD_PrintFormatItem SET PrintName='TargetAccount', Name='TargetAccount' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3000110)
;
...
-- On drawer Checks, new columns and fields
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3000895,1,'Y','N','N',3000825,'N','Y',3000018,'N','LAR','IsBounced',100,0,TO_TIMESTAMP('2012-09-10 07:12:28','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_TIMESTAMP('2012-09-10 07:12:28','YYYY-MM-DD HH24:MI:SS'))
;
...
-- On drawer Checks, new columns and fields
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3000896,1,'Y','N','N',3000826,'N','Y',3000018,'N','LAR','IsDeposited',100,0,TO_TIMESTAMP('2012-09-10 07:12:29','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_TIMESTAMP('2012-09-10 07:12:29','YYYY-MM-DD HH24:MI:SS'))
;
...
-- On drawer Checks, new columns and fields
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,Created,IsActive,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3000897,60,'Y','N','N',3000824,'N','Y',3000018,'N','LAR','TargetAccount',100,0,TO_TIMESTAMP('2012-09-10 07:12:31','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,TO_TIMESTAMP('2012-09-10 07:12:31','YYYY-MM-DD HH24:MI:SS'))
;
...
-- On drawer Checks, new columns and fields
UPDATE AD_Tab SET WhereClause='AD_Org_ID NOT IN (1000001, 1000005) AND IsReceipt=''Y'' AND TenderType=''K'' AND IsReconciled=''N'' AND Docstatus NOT IN (''DR'', ''VO'', ''RE'')',Updated=TO_TIMESTAMP('2012-09-10 07:16:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=3000018
;
