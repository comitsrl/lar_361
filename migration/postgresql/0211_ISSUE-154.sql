...
-- PRT 2: Configuración Productos.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001247,'producida','LAR','producida','producida',0,TO_TIMESTAMP('2022-05-11 19:15:20','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2022-05-11 19:15:20','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- 11/05/2022 19:15:21 ART
-- PRT 2: Configuración Productos.
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsKey,AD_Element_ID,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Name,ColumnName,Updated,CreatedBy,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (3004461,259,'LAR',0,'Y','N','N','N',1,'N',20,'N',3001247,'N','Y','N','producida','producida',TO_TIMESTAMP('2022-05-11 19:15:20','YYYY-MM-DD HH24:MI:SS'),100,0,0,'Y',TO_TIMESTAMP('2022-05-11 19:15:20','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- PRT 2: Configuración Productos.
UPDATE AD_Column SET ColumnName='Producida',Updated=TO_TIMESTAMP('2022-05-11 19:15:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004461
;

-- 11/05/2022 19:16:06 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Column_Trl SET Name='Producida',Updated=TO_TIMESTAMP('2022-05-11 19:16:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3004461 AND AD_Language='es_AR'
;

-- 11/05/2022 19:16:49 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Element SET ColumnName='Producida', Name='Producida', PrintName='Producida',Updated=TO_TIMESTAMP('2022-05-11 19:16:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001247
;
...
-- 11/05/2022 19:16:49 ART
-- PRT 2: Configuración Productos.
UPDATE AD_PrintFormatItem SET PrintName='Producida', Name='Producida' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001247)
;

-- 11/05/2022 19:16:54 ART
-- PRT 2: Configuración Productos.
UPDATE AD_Element_Trl SET Name='Producida',PrintName='Producida',Updated=TO_TIMESTAMP('2022-05-11 19:16:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001247 AND AD_Language='es_AR'
;

-- 11/05/2022 19:17:37 ART
-- PRT 2: Configuración Productos.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,Updated,CreatedBy) VALUES ('N',3007780,1,'Y','N','N',3004461,'N','Y',186,'N','LAR','Producida',100,0,'Y',TO_TIMESTAMP('2022-05-11 19:17:36','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2022-05-11 19:17:36','YYYY-MM-DD HH24:MI:SS'),100)
;
