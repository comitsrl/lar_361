...
-- 16/06/2020 18:24:04 ART
-- ISSUE #77: Configuración Facturación Electronica.
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 100,t.AD_Tree_ID, 3000369, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=3000369)
;
...
-- 16/06/2020 18:24:10 ART
-- ISSUE #77: Configuración Facturación Electronica.
UPDATE AD_TreeNodeMM SET Parent_ID=3000000, SeqNo=2, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=3000369
;
...
-- 16/06/2020 18:24:21 ART
-- ISSUE #77: Configuración Facturación Electronica.
UPDATE AD_TreeNodeMM SET Parent_ID=3000000, SeqNo=3, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=3000367
;
...
-- ISSUE #77: Configuración Facturación Electronica.
UPDATE AD_TreeNodeMM SET Parent_ID=3000369, SeqNo=0, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=3000367
;

-- 13/07/2020 21:12:28 ART
-- ISSUE #77: Marca identificatoria, para impuestos internos.
INSERT INTO AD_Element (AD_Element_ID,ColumnName,EntityType,Name,PrintName,AD_Client_ID,Created,Updated,IsActive,AD_Org_ID,CreatedBy,UpdatedBy) VALUES (3001082,'esimpuestointerno','LAR','esimpuestointerno','esimpuestointerno',0,TO_TIMESTAMP('2020-07-13 21:12:28','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2020-07-13 21:12:28','YYYY-MM-DD HH24:MI:SS'),'Y',0,100,100)
;
...
-- ISSUE #77: Marca identificatoria, para impuestos internos.
UPDATE AD_Column SET Name='Es Impuesto Interno', ColumnName='EsImpuestoInterno',Updated=TO_TIMESTAMP('2020-07-13 21:13:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003672
;
...
-- ISSUE #77: Marca identificatoria, para impuestos internos.
UPDATE AD_Column_Trl SET Name='Es Impuesto Interno',Updated=TO_TIMESTAMP('2020-07-13 21:13:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3003672 AND AD_Language='es_AR'
;

-- 13/07/2020 21:13:50 ART
-- ISSUE #77: Marca identificatoria, para impuestos internos.
UPDATE AD_Element SET ColumnName='EsImpuestoInterno', Name='Es Impuesto Interno', PrintName='Es Impuesto Interno',Updated=TO_TIMESTAMP('2020-07-13 21:13:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001082
;
...
-- 13/07/2020 21:13:50 ART
-- ISSUE #77: Marca identificatoria, para impuestos internos.
UPDATE AD_PrintFormatItem SET PrintName='Es Impuesto Interno', Name='Es Impuesto Interno' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=3001082)
;

-- 13/07/2020 21:13:56 ART
-- ISSUE #77: Marca identificatoria, para impuestos internos.
UPDATE AD_Element_Trl SET Name='Es Impuesto Interno',PrintName='Es Impuesto Interno',Updated=TO_TIMESTAMP('2020-07-13 21:13:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=3001082 AND AD_Language='es_AR'
;

-- 13/07/2020 21:15:03 ART
-- ISSUE #77: Marca identificatoria, para impuestos internos.
INSERT INTO AD_Field (IsEncrypted,AD_Field_ID,DisplayLength,IsDisplayed,IsSameLine,IsHeading,AD_Column_ID,IsFieldOnly,IsCentrallyMaintained,AD_Tab_ID,IsReadOnly,EntityType,Name,UpdatedBy,AD_Org_ID,IsActive,Created,AD_Client_ID,CreatedBy,Updated) VALUES ('N',3006893,1,'Y','N','N',3003672,'N','Y',174,'N','LAR','Es Impuesto Interno',100,0,'Y',TO_TIMESTAMP('2020-07-13 21:15:03','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2020-07-13 21:15:03','YYYY-MM-DD HH24:MI:SS'))
;
...
UPDATE AD_Column SET MandatoryLogic='@TargetDocBaseType@=''ARC''',Updated=TO_TIMESTAMP('2020-07-16 21:29:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3000265
;

-- 16/07/2020 21:33:54 ART
-- BUG #377: Ajustes de Ventanas y traducciones
UPDATE AD_Field SET DisplayLogic='@TargetDocBaseType@=''ARC'' | @DocSubTypeCAE@=202 | @DocSubTypeCAE@=2 | @DocSubTypeCAE@=207 | @DocSubTypeCAE@=7 | @DocSubTypeCAE@=212 | @DocSubTypeCAE@=52',Updated=TO_TIMESTAMP('2020-07-16 21:33:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=3000603
;

-- Registración de script
SELECT register_migration_script_lar('0155_ISSUE-77.sql', 'LAR', '')
;
